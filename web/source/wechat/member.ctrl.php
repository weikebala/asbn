		...
		'card' => array(
			...
			'member_card' => array(
				'base_info' => array(
					...
					'custom_url' => urlencode('http://bbs.iseasoft.cn'),
					'custom_url_sub_title' => urlencode('6个汉字tips'),
					'promotion_url_name' => urlencode('营销入口1'),
					'promotion_url' => urlencode('http://www.iseasoft.cn'),
				),
				'supply_bonus' => true,
				...
				'custom_field1' => array(
					...
					'url' => urlencode('http://www.iseasoft.cn'),
				),
				'activate_url' => urlencode('http://bbs.iseasoft.cn'),
				'custom_cell1' => array(
					'name' => urlencode('使用入口2'),
					'tips' => urlencode('激活后显示'),
					'url' => urlencode('http://bbs.iseasoft.cn'),
				)
			),
		),
	);
