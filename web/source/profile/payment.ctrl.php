...
if($_W['ispost']) {
	...
	$alipay = array_elements(array('switch', 'account', 'partner', 'secret','bilv'), $_GPC['alipay']);
	$alipay['switch'] = $alipay['switch'] == 'true';
	$alipay['account'] = trim($alipay['account']);
	$alipay['partner'] = trim($alipay['partner']);
	$alipay['bilv'] = trim($alipay['bilv']);
	...
	if($alipay['switch'] && (empty($alipay['account']) || empty($alipay['partner']) || empty($alipay['secret']) || empty($alipay['bilv']))) {
    ...
    $abcchinapay = array_elements(array('switch'), $_GPC['abcchinapay']);
    $abcchinapay['switch'] = $abcchinapay['switch'] == 'true';
