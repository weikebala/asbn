...
require IA_ROOT . '/web/source/members/common/common.inc.php';
load()->web('common');
load()->web('template');
...
if($verify_result || $verify_result2) {//验证成功
    ...
    //验证失败
    echo "fail";
    header("location:".$_W["siteroot"]."web/index.php?c=site&a=entry&do=getPayResult&m=kim_financial&order_no=".$_GPC['out_trade_no']);
    return;
