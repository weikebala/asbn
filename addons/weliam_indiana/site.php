...
class weliam_indianaModuleSite extends WeModuleSite {
	...
	public function payResult($params){
		...
		if ($params['result'] == 'success' && $params['from'] == 'notify') {
			...
			file_put_contents(WELIAM_INDIANA."/params.log", var_export('******记录params******', true).PHP_EOL, FILE_APPEND);
			file_put_contents(WELIAM_INDIANA."/params.log", var_export($params, true).PHP_EOL, FILE_APPEND);
			file_put_contents(WELIAM_INDIANA."/params.log", var_export('******记录record******', true).PHP_EOL, FILE_APPEND);
		...
		if ($params['from'] == 'return' && $params['result'] == 'success') {
			...
			$data  = array(
				"name"=>array( "value"=> "云支付成功！预祝中大奖1！","color"=>"#173177"),
