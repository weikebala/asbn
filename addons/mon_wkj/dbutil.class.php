...
class DBUtil
{
    ...
    public static $TABLE_WKJ = "mon_wkj";

    public static $TABLE_WKJ_USER = "mon_wkj_user";

    public static $TABLE_WKJ_FIREND = "mon_wkj_firend";

    public static $TABLE_WJK_ORDER = "mon_wkj_order";

    public static $TABLE_WKJ_SETTING = "mon_wkj_setting";
