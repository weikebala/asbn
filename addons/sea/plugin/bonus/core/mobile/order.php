...
if ($_W['isajax']) {
    ...
    $psize = 20;
    $list = array();
    $sql = 'select o.id,o.ordersn,o.openid,o.status,o.createtime,cg.money from ' . tablename('sea_order') . ' o' . ' left join ' . tablename('sea_bonus_goods') . " cg on cg.orderid=o.id where 1 {$conditionq} and bonus_area=0 and o.uniacid=" . $_W['uniacid'] . " and cg.mid ={$member['id']} ORDER BY o.createtime DESC,o.status DESC  ";
