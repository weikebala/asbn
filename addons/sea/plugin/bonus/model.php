...
if (!class_exists('BonusModel')) {
    class BonusModel extends PluginModel
    {
        ...
        public function getParentAgents($_var_1, $_var_2 = 0,$type=false)
        {
            global $_W;
            $_var_3 = 'select id, agentid, bonuslevel, bonus_status from ' . tablename('sea_member') . " where id={$_var_1} and uniacid=" . $_W['uniacid'];
            ...
            if (empty($_var_4)) {
                ...
                if($type) {
                    if ($_var_4['agentid'] != 0) {
                        $_var_33 = 'select id, agentid, bonuslevel, bonus_status from ' . tablename('sea_member') . " where id={$_var_4['agentid']} and uniacid=" . $_W['uniacid'];
                        $_var_44 = pdo_fetch($_var_33);
                        if (empty($this->parentAgents[$_var_44['bonuslevel']])) {
                            $this->parentAgents[$_var_44['bonuslevel']] = $_var_44['id'];
                        }
                    }
                    else {
        ...
        public function calculate($_var_5 = 0, $_var_6 = true)
        {
            ...
            foreach ($_var_12 as $_var_14) {
                ...
                if (!empty($_var_16)) {
                    $_var_17 = $this->getParentAgents($_var_16, 1,true);
                    $_var_18 = 0;
                    foreach ($_var_7 as $_var_19 => $_var_20) {
                        ...
                        if (array_key_exists($_var_21, $_var_17)) {
                            ...
                            pdo_insert('sea_bonus_goods', $_var_25);
                        }
                    }
                }
                if (!empty($_var_0['area_start'])) {
                    $_var_26 = 0;
                    $_var_27 = floatval($_var_0['bonus_commission3']);
                    if (!empty($_var_27)) {
                        $_var_28 = pdo_fetch('select id, bonus_area_commission from ' . tablename('sea_member') . ' where bonus_province=\'' . $_var_11['province'] . '\' and bonus_city=\'' . $_var_11['city'] . '\' and bonus_district=\'' . $_var_11['area'] . '\' and bonus_area=3 and uniacid=' . $_W['uniacid']);
                        if (!empty($_var_28)) {
                            ...
                            if ($_var_29 > 0) {
                                $_var_25 = array('uniacid' => $_W['uniacid'], 'ordergoodid' => $_var_14['goodsid'], 'orderid' => $_var_5, 'total' => $_var_14['total'], 'optionname' => $_var_14['optionname'], 'mid' => $_var_28['id'], 'bonus_area' => 3, 'money' => $_var_29, 'createtime' => $_var_8);
                            }
                            pdo_insert('sea_bonus_goods', $_var_25);
                        }
                    }
                    ...
                    if (!empty($_var_30)) {
                        $_var_31 = pdo_fetch('select id, bonus_area_commission from ' . tablename('sea_member') . ' where bonus_province=\'' . $_var_11['province'] . '\' and bonus_city=\'' . $_var_11['city'] . '\' and bonus_area=2 and uniacid=' . $_W['uniacid']);
                        if (!empty($_var_31)) {
                    ...
                    $_var_32 = floatval($_var_0['bonus_commission1']);
                    if (!empty($_var_32)) {
                        $_var_33 = pdo_fetch('select id, bonus_area_commission from ' . tablename('sea_member') . ' where bonus_province=\'' . $_var_11['province'] . '\' and bonus_area=1 and uniacid=' . $_W['uniacid']);
                        if (!empty($_var_33)) {
                            ...
                            if ($_var_29 > 0) {
                                $_var_25 = array('uniacid' => $_W['uniacid'], 'ordergoodid' => $_var_14['goodsid'], 'orderid' => $_var_5, 'total' => $_var_14['total'], 'optionname' => $_var_14['optionname'], 'mid' => $_var_33['id'], 'bonus_area' => 1, 'money' => $_var_29, 'createtime' => $_var_8);
                                pdo_insert('sea_bonus_goods', $_var_25);
                            }
                        }
                    }
        ...
        {
            global $_W;
            $_var_3 = 'select id from ' . tablename('sea_member') . " where agentid={$_var_1} and status=1 and isagent = 1 and uniacid=" . $_W['uniacid'];
        ...
        public function getLevels($_var_36 = true)
        {
            global $_W;
            if ($_var_36) {
                return pdo_fetchall('select * from ' . tablename('sea_bonus_level') . ' where uniacid=:uniacid order by level asc', array(':uniacid' => $_W['uniacid']));
            } else {
                return pdo_fetchall('select * from ' . tablename('sea_bonus_level') . ' where uniacid=:uniacid and (ordermoney>0 or commissionmoney>0) order by level asc', array(':uniacid' => $_W['uniacid']));
            }
        }
        public function premierInfo($_var_10, $_var_37 = null)
        {
            ...
            $_var_42 = 0;
            $_var_8 = time();
            $_var_43 = intval($_var_0['settledays']) * 3600 * 24;
            if (in_array('ok', $_var_37)) {
                $_var_3 = 'select sum(o.price) as money from ' . tablename('sea_order') . ' o left join ' . tablename('sea_order_refund') . " r on r.orderid=o.id and ifnull(r.status,-1)<>-1 where 1 and o.status>=3 and o.uniacid={$_W['uniacid']} and ({$_var_8} - o.createtime > {$_var_43}) ORDER BY o.createtime DESC,o.status DESC";
                $_var_39 = pdo_fetchcolumn($_var_3, array(':uniacid' => $_W['uniacid']));
            }
            if (in_array('total', $_var_37)) {
                $_var_3 = 'select sum(o.price) as money from ' . tablename('sea_order') . ' o left join ' . tablename('sea_order_refund') . ' r on r.orderid=o.id and ifnull(r.status,-1)<>-1 where o.status>=1 and o.uniacid=:uniacid  ORDER BY o.createtime DESC,o.status DESC';
                $_var_38 = pdo_fetchcolumn($_var_3, array(':uniacid' => $_W['uniacid']));
            }
            if (in_array('pay', $_var_37)) {
                $_var_3 = 'select sum(money) from ' . tablename('sea_bonus_log') . ' where openid=:openid and isglobal=1 and uniacid=:uniacid';
                $_var_40 = pdo_fetchcolumn($_var_3, array(':uniacid' => $_W['uniacid'], 'openid' => $_var_13['openid']));
            }
            if (in_array('myorder', $_var_44)) {
                $_var_45 = pdo_fetch('select sum(og.realprice) as ordermoney,count(distinct og.orderid) as ordercount from ' . tablename('sea_order') . ' o ' . ' left join  ' . tablename('sea_order_goods') . ' og on og.orderid=o.id ' . ' where o.openid=:openid and o.status>=3 and o.uniacid=:uniacid limit 1', array(':uniacid' => $_W['uniacid'], ':openid' => $_var_13['openid']));
        ...
        public function getInfo($_var_10, $_var_37 = null)
        {
            ...
            if (in_array('totaly', $_var_37)) {
                $_var_3 = 'select sum(money) as money from ' . tablename('sea_order') . ' o left join  ' . tablename('sea_bonus_goods') . '  cg on o.id=cg.orderid and cg.status=0 left join ' . tablename('sea_order_refund') . " r on r.orderid=o.id and ifnull(r.status,-1)<>-1 where 1 and o.status>=0 and o.uniacid={$_W['uniacid']} and cg.mid = {$_var_52} and cg.bonus_area = 0";
            ...
            if (in_array('total', $_var_37)) {
                $_var_3 = 'select sum(money) as money from ' . tablename('sea_order') . ' o left join  ' . tablename('sea_bonus_goods') . '  cg on o.id=cg.orderid left join ' . tablename('sea_order_refund') . " r on r.orderid=o.id and ifnull(r.status,-1)<>-1 where o.status>=1 and o.uniacid=:uniacid and cg.mid = {$_var_52} ORDER BY o.createtime DESC,o.status DESC";
                $_var_38 = pdo_fetchcolumn($_var_3, array(':uniacid' => $_W['uniacid']));
            }
            if (in_array('ordercount', $_var_37)) {
                $_var_53 = pdo_fetchcolumn('select count(distinct o.id) as ordercount from ' . tablename('sea_order') . ' o ' . ' left join  ' . tablename('sea_bonus_goods') . ' cg on cg.orderid=o.id  where o.status>=0 and cg.status>=0 and o.uniacid=' . $_W['uniacid'] . ' and cg.mid =' . $_var_52 . ' and cg.bonus_area=0 limit 1');
            }
            if (in_array('ordercount_area', $_var_37)) {
                $_var_51 = pdo_fetchcolumn('select count(distinct o.id) as ordercount_area from ' . tablename('sea_order') . ' o ' . ' left join  ' . tablename('sea_bonus_goods') . ' cg on cg.orderid=o.id  where o.status>=0 and cg.status>=0 and o.uniacid=' . $_W['uniacid'] . ' and cg.mid =' . $_var_52 . ' and cg.bonus_area!=0 limit 1');
            }
            if (in_array('apply', $_var_37)) {
                $_var_3 = 'select sum(money) as money from ' . tablename('sea_order') . ' o left join  ' . tablename('sea_bonus_goods') . '  cg on o.id=cg.orderid and cg.status=1 left join ' . tablename('sea_order_refund') . " r on r.orderid=o.id and ifnull(r.status,-1)<>-1 where 1 and o.status>=3 and o.uniacid={$_W['uniacid']} and cg.mid = {$_var_52} and ({$_var_8} - o.createtime <= {$_var_43}) ORDER BY o.createtime DESC,o.status DESC";
                $_var_46 = pdo_fetchcolumn($_var_3);
            }
            if (in_array('check', $_var_37)) {
                $_var_3 = 'select sum(money) as money from ' . tablename('sea_order') . ' o left join  ' . tablename('sea_bonus_goods') . '  cg on o.id=cg.orderid and cg.status=2 left join ' . tablename('sea_order_refund') . " r on r.orderid=o.id and ifnull(r.status,-1)<>-1 where 1 and o.status>=3 and o.uniacid={$_W['uniacid']} and cg.mid = {$_var_52} and ({$_var_8} - o.createtime <= {$_var_43}) ORDER BY o.createtime DESC,o.status DESC";
                $_var_47 = pdo_fetchcolumn($_var_3);
            }
            if (in_array('pay', $_var_37)) {
                $_var_3 = 'select sum(money) as money from ' . tablename('sea_order') . ' o left join  ' . tablename('sea_bonus_goods') . '  cg on o.id=cg.orderid and cg.status=3 left join ' . tablename('sea_order_refund') . " r on r.orderid=o.id and ifnull(r.status,-1)<>-1 where 1 and o.status>=3 and o.uniacid={$_W['uniacid']} and cg.mid = {$_var_52} ORDER BY o.createtime DESC,o.status DESC";
        ...
        public function checkOrderPay($_var_5 = '0')
        {
            ...
            $_var_9 = pdo_fetch('select id,openid,ordersn,goodsprice,agentid,paytime from ' . tablename('sea_order') . ' where id=:id and status>=1 and uniacid=:uniacid limit 1', array(':id' => $_var_5, ':uniacid' => $_W['uniacid']));
            if (empty($_var_9)) {
                return;
            }
            $_var_10 = $_var_9['openid'];
            ...
            $_var_56 = pdo_fetchall('select g.id,g.title,og.total,og.price,og.realprice, og.optionname as optiontitle,g.noticeopenid,g.noticetype,og.commission1 from ' . tablename('sea_order_goods') . ' og ' . ' left join ' . tablename('sea_goods') . ' g on g.id=og.goodsid ' . ' where og.uniacid=:uniacid and og.orderid=:orderid ', array(':uniacid' => $_W['uniacid'], ':orderid' => $_var_9['id']));
            $_var_12 = '';
            $_var_57 = 0;
            ...
            $_var_59 = pdo_fetchall('select distinct mid from ' . tablename('sea_bonus_goods') . ' where uniacid=:uniacid and orderid=:orderid', array(':orderid' => $_var_9['id'], ':uniacid' => $_W['uniacid']));
            foreach ($_var_59 as $_var_19 => $_var_60) {
                $_var_10 = pdo_fetchcolumn('select openid from ' . tablename('sea_member') . ' where id=' . $_var_60['mid'] . ' and uniacid=' . $_W['uniacid']);
                $_var_61 = pdo_fetchcolumn('select sum(money) from ' . tablename('sea_bonus_goods') . ' where mid=' . $_var_60['mid'] . ' and orderid=' . $_var_9['id'] . ' and bonus_area=0 and uniacid=' . $_W['uniacid']);
        ...
        public function checkOrderFinish($_var_5 = '')
        {
            ...
            $_var_9 = pdo_fetch('select id,openid,ordersn,goodsprice,agentid,paytime,finishtime from ' . tablename('sea_order') . ' where id=:id and status>=1 and uniacid=:uniacid limit 1', array(':id' => $_var_5, ':uniacid' => $_W['uniacid']));
            if (empty($_var_9)) {
                return;
            }
            $_var_10 = $_var_9['openid'];
            ...
            $_var_59 = pdo_fetchall('select distinct mid from ' . tablename('sea_bonus_goods') . ' where uniacid=:uniacid and orderid=:orderid', array(':orderid' => $_var_5, ':uniacid' => $_W['uniacid']));
            foreach ($_var_59 as $_var_19 => $_var_60) {
                $_var_10 = pdo_fetchcolumn('select openid from ' . tablename('sea_member') . ' where id=' . $_var_60['mid'] . ' and uniacid=' . $_W['uniacid']);
                $_var_61 = pdo_fetchcolumn('select sum(money) from ' . tablename('sea_bonus_goods') . ' where mid=' . $_var_60['mid'] . ' and orderid=' . $_var_9['id'] . ' and bonus_area=0 and uniacid=' . $_W['uniacid']);
        ...
        public function getLevel($_var_10)
        {
            ...
            $_var_20 = pdo_fetch('select * from ' . tablename('sea_bonus_level') . ' where uniacid=:uniacid and id=:id limit 1', array(':uniacid' => $_W['uniacid'], ':id' => $_var_13['bonuslevel']));
            return $_var_20;
        }
        public function upgradeLevelByAgent($_var_62)
        {
            ...
            if (empty($_var_13['bonuslevel'])) {
                $_var_63 = false;
                $_var_64 = pdo_fetch('select * from ' . tablename('sea_bonus_level') . ' where uniacid=' . $_W['uniacid'] . ' order by level asc');
            } else {
                $_var_63 = $this->getLevel($_var_13['openid']);
                $_var_65 = pdo_fetchcolumn('select level from ' . tablename('sea_bonus_level') . ' where  uniacid=:uniacid and id=:bonuslevel order by level asc', array(':uniacid' => $_W['uniacid'], ':bonuslevel' => $_var_13['bonuslevel']));
                $_var_64 = pdo_fetch('select * from ' . tablename('sea_bonus_level') . ' where  uniacid=:uniacid and level>:levelby order by level asc', array(':uniacid' => $_W['uniacid'], ':levelby' => $_var_65));
            }
            if (empty($_var_64)) {
                return false;
            }
            ...
            if (in_array('4', $_var_66)) {
                $_var_68 = pdo_fetchcolumn('select sum(price) from ' . tablename('sea_order') . ' where openid=:openid and status>=3 and uniacid=:uniacid limit 1', array(':uniacid' => $_W['uniacid'], ':openid' => $_var_13['openid']));
            ...
            if ($_var_67 == true) {
                pdo_update('sea_member', array('bonuslevel' => $_var_64['id'], 'bonus_status' => _func_0), array('id' => $_var_13['id']));
                                    ...
                                    if ($_var_70 == TM_BONUS_GLOBAL_PAY && !empty($_var_71['bonus_global_pay']) && empty($_var_73['bonus_global_pay'])) {
                                        ...
                                        if ($_var_70 == TM_BONUS_UPGRADE && !empty($_var_71['bonus_upgrade']) && empty($_var_73['bonus_upgrade'])) {
                                            ...
                                            if ($_var_70 == TM_COMMISSION_BECOME && !empty($_var_71['commission_become']) && empty($_var_73['commission_become'])) {
                                                ...
                                                $_var_75 = array('keyword1' => array('value' => !empty($_var_71['commission_becometitle']) ? $_var_71['commission_becometitle'] : '成为加盟商通知', 'color' => '#73a68d'), 'keyword2' => array('value' => $_var_74, 'color' => '#73a68d'));
                                                if (!empty($_var_72)) {
                                                    m('message')->sendTplNotice($_var_10, $_var_72, $_var_75);
                                                } else {
                                                    m('message')->sendCustomNotice($_var_10, $_var_75);
        ...
        public function autosend()
        {
            ...
            $_var_43 = intval($_var_0['settledays']) * 3600 * 24;
            $_var_3 = 'select distinct cg.mid from ' . tablename('sea_bonus_goods') . ' cg left join  ' . tablename('sea_order') . '  o on o.id=cg.orderid and cg.status=0 left join ' . tablename('sea_order_refund') . " r on r.orderid=o.id and ifnull(r.status,-1)<>-1 where 1 and o.status>=3 and o.uniacid={$_W['uniacid']} and ({$_var_80} - o.finishtime > {$_var_43})  ORDER BY o.finishtime DESC,o.status DESC";
            ...
            foreach ($_var_81 as $_var_19 => $_var_83) {
                ...
                pdo_insert('sea_bonus_log', array('openid' => $_var_13['openid'], 'uid' => $_var_13['uid'], 'money' => $_var_84, 'uniacid' => $_W['uniacid'], 'paymethod' => $_var_0['paymethod'], 'sendpay' => $_var_85, 'status' => 1, 'ctime' => time(), 'send_bonus_sn' => $_var_8));
                if ($_var_85 == 1) {
                ...
                pdo_update('sea_bonus_goods', $_var_59, array('mid' => $_var_13['id'], 'uniacid' => $_W['uniacid']));
        ...
        public function autosendall()
        {
            ...
            $_var_79 = strtotime(date('Y-m-d 00:00:00'));
            if (empty($_var_0['sendmonth'])) {
                $_var_89 = $_var_79 - 86400;
                $_var_80 = $_var_79 - 1;
            } else {
                if ($_var_0['sendmonth'] == 1) {
                    $_var_89 = mktime(0, 0, 0, date('m') - 1, 1, date('Y'));
                    $_var_80 = mktime(0, 0, 0, date('m'), 1, date('Y')) - 1;
                }
            }
            $_var_3 = 'select sum(o.price) from ' . tablename('sea_order') . ' o left join ' . tablename('sea_order_refund') . " r on r.orderid=o.id and ifnull(r.status,-1)<>-1 where 1 and o.status>=3 and o.uniacid={$_W['uniacid']} and  o.finishtime >={$_var_89} and o.finishtime < {$_var_80}  ORDER BY o.finishtime DESC,o.status DESC";
            $_var_90 = pdo_fetchcolumn($_var_3);
            $_var_91 = pdo_fetchall('select * from ' . tablename('sea_bonus_level') . " where uniacid={$_W['uniacid']} and premier=1");
            $_var_92 = array();
            $_var_82 = 0;
            foreach ($_var_91 as $_var_19 => $_var_83) {
                $_var_93 = pdo_fetchcolumn('select count(*) from ' . tablename('sea_member') . " where uniacid={$_W['uniacid']} and bonuslevel=" . $_var_83['id'] . ' and bonus_status = 1');
                if ($_var_93 > 0) {
            ...
            $_var_96 = pdo_fetchall('select m.* from ' . tablename('sea_member') . ' m left join ' . tablename('sea_bonus_level') . " l on m.bonuslevel=l.id and m.bonus_status=1 where 1 and l.premier=1 and m.uniacid={$_W['uniacid']}");
            foreach ($_var_96 as $_var_19 => $_var_83) {
                $_var_20 = pdo_fetch('select id, levelname from ' . tablename('sea_bonus_level') . ' where id=' . $_var_97['bonuslevel']);
                ...
                pdo_insert('sea_bonus_log', array('openid' => $_var_13['openid'], 'uid' => $_var_13['uid'], 'money' => $_var_84, 'uniacid' => $_W['uniacid'], 'paymethod' => $_var_0['paymethod'], 'sendpay' => $_var_85, 'isglobal' => 1, 'status' => 1, 'ctime' => time(), 'send_bonus_sn' => $_var_8));
                if ($_var_85 == 1) {
            ...
            if ($_var_77) {
                $_var_88 = array('uniacid' => $_W['uniacid'], 'money' => $_var_82, 'status' => 1, 'ctime' => time(), 'paymethod' => $_var_0['paymethod'], 'sendpay_error' => $_var_76, 'isglobal' => 1, 'utime' => $_var_79, 'send_bonus_sn' => $_var_8, 'total' => $_var_98);
                pdo_insert('sea_bonus', $_var_88);
            }
        }
    }
