...
if (!class_exists('SupplierModel')) {
    class SupplierModel extends PluginModel
    {
        ...
        public function getInfo($_var_0, $_var_1 = null)
        {
            ...
            if ($_var_3 >= 1) {
                if (in_array('ordercount0', $_var_1)) {
                    $_var_36 = pdo_fetch('select sum(og.realprice) as ordermoney,count(distinct o.id) as ordercount from ' . tablename('sea_order') . ' o ' . ' left join  ' . tablename('sea_order_goods') . ' og on og.orderid=o.id ' . ' where o.agentid=:agentid and o.status>=0 and og.status1>=0 and og.nocommission=0 and o.uniacid=:uniacid  limit 1', array(':uniacid' => $_W['uniacid'], ':agentid' => $_var_4['id']));
                    $_var_24 += $_var_36['ordercount'];
                    $_var_9 += $_var_36['ordercount'];
                    $_var_10 += $_var_36['ordermoney'];
                }
                if (in_array('ordercount', $_var_1)) {
                    $_var_36 = pdo_fetch('select sum(og.realprice) as ordermoney,count(distinct o.id) as ordercount from ' . tablename('sea_order') . ' o ' . ' left join  ' . tablename('sea_order_goods') . ' og on og.orderid=o.id ' . ' where o.agentid=:agentid and o.status>=1 and og.status1>=0 and og.nocommission=0 and o.uniacid=:uniacid  limit 1', array(':uniacid' => $_W['uniacid'], ':agentid' => $_var_4['id']));
                    $_var_27 += $_var_36['ordercount'];
                    $_var_11 += $_var_36['ordercount'];
                    $_var_12 += $_var_36['ordermoney'];
                }
                if (in_array('ordercount3', $_var_1)) {
                    $_var_37 = pdo_fetch('select sum(og.realprice) as ordermoney,count(distinct o.id) as ordercount from ' . tablename('sea_order') . ' o ' . ' left join  ' . tablename('sea_order_goods') . ' og on og.orderid=o.id ' . ' where o.agentid=:agentid and o.status>=3 and og.status1>=0 and og.nocommission=0 and o.uniacid=:uniacid  limit 1', array(':uniacid' => $_W['uniacid'], ':agentid' => $_var_4['id']));
                ...
                if (in_array('total', $_var_1)) {
                    $_var_38 = pdo_fetchall('select og.commission1,og.commissions  from ' . tablename('sea_order_goods') . ' og ' . ' left join  ' . tablename('sea_order') . ' o on o.id = og.orderid' . ' where o.agentid=:agentid and o.status>=1 and og.nocommission=0 and o.uniacid=:uniacid', array(':uniacid' => $_W['uniacid'], ':agentid' => $_var_4['id']));
                ...
                if (in_array('ok', $_var_1)) {
                    $_var_38 = pdo_fetchall('select og.commission1,og.commissions  from ' . tablename('sea_order_goods') . ' og ' . ' left join  ' . tablename('sea_order') . ' o on o.id = og.orderid' . " where o.agentid=:agentid and o.status>=3 and og.nocommission=0 and ({$_var_6} - o.createtime > {$_var_7}) and og.status1=0  and o.uniacid=:uniacid", array(':uniacid' => $_W['uniacid'], ':agentid' => $_var_4['id']));
                    foreach ($_var_38 as $_var_39) {
                        $_var_40 = iunserializer($_var_39['commissions']);
                        $_var_41 = iunserializer($_var_39['commission1']);
                        if (empty($_var_40)) {
                ...
                if (in_array('lock', $_var_1)) {
                    $_var_42 = pdo_fetchall('select og.commission1,og.commissions  from ' . tablename('sea_order_goods') . ' og ' . ' left join  ' . tablename('sea_order') . ' o on o.id = og.orderid' . " where o.agentid=:agentid and o.status>=3 and og.nocommission=0 and ({$_var_6} - o.createtime <= {$_var_7})  and og.status1=0  and o.uniacid=:uniacid", array(':uniacid' => $_W['uniacid'], ':agentid' => $_var_4['id']));
                ...
                if (in_array('apply', $_var_1)) {
                    $_var_43 = pdo_fetchall('select og.commission1,og.commissions  from ' . tablename('sea_order_goods') . ' og ' . ' left join  ' . tablename('sea_order') . ' o on o.id = og.orderid' . ' where o.agentid=:agentid and o.status>=3 and og.status1=1 and og.nocommission=0 and o.uniacid=:uniacid', array(':uniacid' => $_W['uniacid'], ':agentid' => $_var_4['id']));
                ...
                if (in_array('check', $_var_1)) {
                    $_var_43 = pdo_fetchall('select og.commission1,og.commissions  from ' . tablename('sea_order_goods') . ' og ' . ' left join  ' . tablename('sea_order') . ' o on o.id = og.orderid' . ' where o.agentid=:agentid and o.status>=3 and og.status1=2 and og.nocommission=0 and o.uniacid=:uniacid ', array(':uniacid' => $_W['uniacid'], ':agentid' => $_var_4['id']));
                    foreach ($_var_43 as $_var_39) {
                        $_var_40 = iunserializer($_var_39['commissions']);
                        $_var_41 = iunserializer($_var_39['commission1']);
                        if (empty($_var_40)) {
                ...
                if (in_array('pay', $_var_1)) {
                    $_var_43 = pdo_fetchall('select og.commission1,og.commissions  from ' . tablename('sea_order_goods') . ' og ' . ' left join  ' . tablename('sea_order') . ' o on o.id = og.orderid' . ' where o.agentid=:agentid and o.status>=3 and og.status1=3 and og.nocommission=0 and o.uniacid=:uniacid ', array(':uniacid' => $_W['uniacid'], ':agentid' => $_var_4['id']));
                    foreach ($_var_43 as $_var_39) {
                        $_var_40 = iunserializer($_var_39['commissions']);
                        $_var_41 = iunserializer($_var_39['commission1']);
                        if (empty($_var_40)) {
                ...
                $_var_44 = pdo_fetchall('select id from ' . tablename('sea_member') . ' where agentid=:agentid and isagent=1 and status=1 and uniacid=:uniacid ', array(':uniacid' => $_W['uniacid'], ':agentid' => $_var_4['id']), 'id');
            ...
            if ($_var_3 >= 2) {
                if ($_var_21 > 0) {
                    if (in_array('ordercount0', $_var_1)) {
                        $_var_45 = pdo_fetch('select sum(og.realprice) as ordermoney,count(distinct o.id) as ordercount from ' . tablename('sea_order') . ' o ' . ' left join  ' . tablename('sea_order_goods') . ' og on og.orderid=o.id ' . ' where o.agentid in( ' . implode(',', array_keys($_var_44)) . ')  and o.status>=0 and og.status2>=0 and og.nocommission=0 and o.uniacid=:uniacid limit 1', array(':uniacid' => $_W['uniacid']));
                        $_var_25 += $_var_45['ordercount'];
                        $_var_9 += $_var_45['ordercount'];
                        $_var_10 += $_var_45['ordermoney'];
                    }
                    if (in_array('ordercount', $_var_1)) {
                        $_var_45 = pdo_fetch('select sum(og.realprice) as ordermoney,count(distinct o.id) as ordercount from ' . tablename('sea_order') . ' o ' . ' left join  ' . tablename('sea_order_goods') . ' og on og.orderid=o.id ' . ' where o.agentid in( ' . implode(',', array_keys($_var_44)) . ')  and o.status>=1 and og.status2>=0 and og.nocommission=0 and o.uniacid=:uniacid limit 1', array(':uniacid' => $_W['uniacid']));
                        $_var_28 += $_var_45['ordercount'];
                        $_var_11 += $_var_45['ordercount'];
                        $_var_12 += $_var_45['ordermoney'];
                    }
                    if (in_array('ordercount3', $_var_1)) {
                        $_var_46 = pdo_fetch('select sum(og.realprice) as ordermoney,count(distinct o.id) as ordercount from ' . tablename('sea_order') . ' o ' . ' left join  ' . tablename('sea_order_goods') . ' og on og.orderid=o.id ' . ' where o.agentid in( ' . implode(',', array_keys($_var_44)) . ')  and o.status>=3 and og.status2>=0 and og.nocommission=0 and o.uniacid=:uniacid limit 1', array(':uniacid' => $_W['uniacid']));
                    ...
                    if (in_array('total', $_var_1)) {
                        $_var_47 = pdo_fetchall('select og.commission2,og.commissions from ' . tablename('sea_order_goods') . ' og ' . ' left join  ' . tablename('sea_order') . ' o on o.id = og.orderid ' . ' where o.agentid in( ' . implode(',', array_keys($_var_44)) . ')  and o.status>=1 and og.nocommission=0 and o.uniacid=:uniacid', array(':uniacid' => $_W['uniacid']));
                    ...
                    if (in_array('ok', $_var_1)) {
                        $_var_47 = pdo_fetchall('select og.commission2,og.commissions  from ' . tablename('sea_order_goods') . ' og ' . ' left join  ' . tablename('sea_order') . ' o on o.id = og.orderid ' . ' where o.agentid in( ' . implode(',', array_keys($_var_44)) . ")  and ({$_var_6} - o.createtime > {$_var_7}) and o.status>=3 and og.status2=0 and og.nocommission=0  and o.uniacid=:uniacid", array(':uniacid' => $_W['uniacid']));
                        foreach ($_var_47 as $_var_39) {
                            $_var_40 = iunserializer($_var_39['commissions']);
                            $_var_41 = iunserializer($_var_39['commission2']);
                            if (empty($_var_40)) {
                    ...
                    if (in_array('apply', $_var_1)) {
                        $_var_49 = pdo_fetchall('select og.commission2,og.commissions  from ' . tablename('sea_order_goods') . ' og ' . ' left join  ' . tablename('sea_order') . ' o on o.id = og.orderid ' . ' where o.agentid in( ' . implode(',', array_keys($_var_44)) . ')  and o.status>=3 and og.status2=1 and og.nocommission=0 and o.uniacid=:uniacid', array(':uniacid' => $_W['uniacid']));
                    ...
                    if (in_array('check', $_var_1)) {
                        $_var_50 = pdo_fetchall('select og.commission2,og.commissions  from ' . tablename('sea_order_goods') . ' og ' . ' left join  ' . tablename('sea_order') . ' o on o.id = og.orderid ' . ' where o.agentid in( ' . implode(',', array_keys($_var_44)) . ')  and o.status>=3 and og.status2=2 and og.nocommission=0 and o.uniacid=:uniacid', array(':uniacid' => $_W['uniacid']));
                    ...
                    if (in_array('pay', $_var_1)) {
                        $_var_50 = pdo_fetchall('select og.commission2,og.commissions  from ' . tablename('sea_order_goods') . ' og ' . ' left join  ' . tablename('sea_order') . ' o on o.id = og.orderid ' . ' where o.agentid in( ' . implode(',', array_keys($_var_44)) . ')  and o.status>=3 and og.status2=3 and og.nocommission=0 and o.uniacid=:uniacid', array(':uniacid' => $_W['uniacid']));
                        foreach ($_var_50 as $_var_39) {
                            $_var_40 = iunserializer($_var_39['commissions']);
                            $_var_41 = iunserializer($_var_39['commission2']);
                            if (empty($_var_40)) {
                    ...
                    $_var_51 = pdo_fetchall('select id from ' . tablename('sea_member') . ' where agentid in( ' . implode(',', array_keys($_var_44)) . ') and isagent=1 and status=1 and uniacid=:uniacid', array(':uniacid' => $_W['uniacid']), 'id');
            ...
            if ($_var_3 >= 3) {
                if ($_var_22 > 0) {
                    if (in_array('ordercount0', $_var_1)) {
                        $_var_52 = pdo_fetch('select sum(og.realprice) as ordermoney,count(distinct og.orderid) as ordercount from ' . tablename('sea_order') . ' o ' . ' left join  ' . tablename('sea_order_goods') . ' og on og.orderid=o.id ' . ' where o.agentid in( ' . implode(',', array_keys($_var_51)) . ')  and o.status>=0 and og.status3>=0 and og.nocommission=0 and o.uniacid=:uniacid limit 1', array(':uniacid' => $_W['uniacid']));
                        $_var_26 += $_var_52['ordercount'];
                        $_var_9 += $_var_52['ordercount'];
                        $_var_10 += $_var_52['ordermoney'];
                    }
                    if (in_array('ordercount', $_var_1)) {
                        $_var_52 = pdo_fetch('select sum(og.realprice) as ordermoney,count(distinct og.orderid) as ordercount from ' . tablename('sea_order') . ' o ' . ' left join  ' . tablename('sea_order_goods') . ' og on og.orderid=o.id ' . ' where o.agentid in( ' . implode(',', array_keys($_var_51)) . ')  and o.status>=1 and og.status3>=0 and og.nocommission=0 and o.uniacid=:uniacid limit 1', array(':uniacid' => $_W['uniacid']));
                        $_var_29 += $_var_52['ordercount'];
                        $_var_11 += $_var_52['ordercount'];
                        $_var_12 += $_var_52['ordermoney'];
                    }
                    if (in_array('ordercount3', $_var_1)) {
                        $_var_53 = pdo_fetch('select sum(og.realprice) as ordermoney,count(distinct og.orderid) as ordercount from ' . tablename('sea_order') . ' o ' . ' left join  ' . tablename('sea_order_goods') . ' og on og.orderid=o.id ' . ' where o.agentid in( ' . implode(',', array_keys($_var_51)) . ')  and o.status>=3 and og.status3>=0 and og.nocommission=0 and o.uniacid=:uniacid limit 1', array(':uniacid' => $_W['uniacid']));
                    ...
                    if (in_array('total', $_var_1)) {
                        $_var_54 = pdo_fetchall('select og.commission3,og.commissions  from ' . tablename('sea_order_goods') . ' og ' . ' left join  ' . tablename('sea_order') . ' o on o.id = og.orderid' . ' where o.agentid in( ' . implode(',', array_keys($_var_51)) . ')  and o.status>=1 and og.nocommission=0 and o.uniacid=:uniacid', array(':uniacid' => $_W['uniacid']));
                    ...
                    if (in_array('lock', $_var_1)) {
                        $_var_55 = pdo_fetchall('select og.commission3,og.commissions  from ' . tablename('sea_order_goods') . ' og ' . ' left join  ' . tablename('sea_order') . ' o on o.id = og.orderid' . ' where o.agentid in( ' . implode(',', array_keys($_var_51)) . ")  and o.status>=3 and ({$_var_6} - o.createtime > {$_var_7}) and og.status3=0  and og.nocommission=0 and o.uniacid=:uniacid", array(':uniacid' => $_W['uniacid']));
                    ...
                    if (in_array('apply', $_var_1)) {
                        $_var_56 = pdo_fetchall('select og.commission3,og.commissions  from ' . tablename('sea_order_goods') . ' og ' . ' left join  ' . tablename('sea_order') . ' o on o.id = og.orderid' . ' where o.agentid in( ' . implode(',', array_keys($_var_51)) . ')  and o.status>=3 and og.status3=1 and og.nocommission=0 and o.uniacid=:uniacid', array(':uniacid' => $_W['uniacid']));
                    ...
                    if (in_array('check', $_var_1)) {
                        $_var_57 = pdo_fetchall('select og.commission3,og.commissions  from ' . tablename('sea_order_goods') . ' og ' . ' left join  ' . tablename('sea_order') . ' o on o.id = og.orderid' . ' where o.agentid in( ' . implode(',', array_keys($_var_51)) . ')  and o.status>=3 and og.status3=2 and og.nocommission=0 and o.uniacid=:uniacid', array(':uniacid' => $_W['uniacid']));
                    ...
                    if (in_array('pay', $_var_1)) {
                        $_var_57 = pdo_fetchall('select og.commission3,og.commissions  from ' . tablename('sea_order_goods') . ' og ' . ' left join  ' . tablename('sea_order') . ' o on o.id = og.orderid' . ' where o.agentid in( ' . implode(',', array_keys($_var_51)) . ')  and o.status>=3 and og.status3=3 and og.nocommission=0 and o.uniacid=:uniacid', array(':uniacid' => $_W['uniacid']));
                        foreach ($_var_57 as $_var_39) {
                            $_var_40 = iunserializer($_var_39['commissions']);
                            $_var_41 = iunserializer($_var_39['commission3']);
                            if (empty($_var_40)) {
                    ...
                    $_var_58 = pdo_fetchall('select id from ' . tablename('sea_member') . ' where uniacid=:uniacid and agentid in( ' . implode(',', array_keys($_var_51)) . ') and isagent=1 and status=1', array(':uniacid' => $_W['uniacid']), 'id');
        ...
        public function order_split($_var_74)
        {
            ...
            $_var_75 = pdo_fetchall('select distinct supplier_uid from ' . tablename('sea_order_goods') . ' where orderid=:orderid and uniacid=:uniacid', array(':orderid' => $_var_74, ':uniacid' => $_W['uniacid']));
            if (count($_var_75) == 1) {
                pdo_update('sea_order', array('supplier_uid' => $_var_75[0]['supplier_uid']), array('id' => $_var_74, 'uniacid' => $_W['uniacid']));
                return;
            }
            $_var_76 = pdo_fetchall('select supplier_uid, id from ' . tablename('sea_order_goods') . ' where orderid=:orderid and uniacid=:uniacid ', array(':orderid' => $_var_74, ':uniacid' => $_W['uniacid']));
            $_var_77 = pdo_fetch('select * from ' . tablename('sea_order') . ' where  id=:id and uniacid=:uniacid limit 1', array(':uniacid' => $_W['uniacid'], ':id' => $_var_74));
            $_var_78 = ture;
            $_var_79 = array();
            ...
            if (!empty($_var_79)) {
                foreach ($_var_79 as $_var_80 => $_var_81) {
                    ...
                    foreach ($_var_81 as $_var_96) {
                        $_var_70 = pdo_fetch('select price,realprice,oldprice,supplier_uid from ' . tablename('sea_order_goods') . ' where id=:id and uniacid=:uniacid ', array(':id' => $_var_96['id'], ':uniacid' => $_W['uniacid']));
