...
//获取xml文件
function cascdeInit(v1,v2,v3,sel_province,sel_city,sel_area) {
    //打开xlmdocm文档
    xmlDoc = loadXmlFile('../addons/sea/plugin/tradearea/template/static/js/Area.xml');
    var dropElement1 = document.getElementById(sel_province);
    var dropElement2 = document.getElementById(sel_city);
    var dropElement3 = document.getElementById(sel_area);
    ...
    if (TopnodeList.length > 0) {
        ...
        if (TopnodeList.length > 0) {
			...
			selectcounty(v3,sel_province,sel_city,sel_area);
        }
    }
}
...
//依据省设置城市，县
*/
function selectCity(sel_province,sel_city,sel_area) {
    var dropElement1 = document.getElementById(sel_province);
    var name = dropElement1.options[dropElement1.selectedIndex].value;     
    countyNodes = TopnodeList[dropElement1.selectedIndex];      
    var province = document.getElementById(sel_city);
    var city = document.getElementById(sel_area);
...
//设置县,区
*/
function selectcounty(v3,sel_province,sel_city,sel_area) {
    var dropElement1 = document.getElementById(sel_province);
    var dropElement2 = document.getElementById(sel_city);
