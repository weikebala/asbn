...
if (!class_exists('YunpayModel')) {
    class YunpayModel extends PluginModel
    {
        ...
        {
            global $_W;
            $_var_0 = pdo_fetch('select * from ' . tablename('sea_sysset') . ' where uniacid=:uniacid limit 1', array(':uniacid' => $_W['uniacid']));
        ...
        public function yunpay_build($_var_6, $_var_3 = array(), $_var_7 = 0, $_var_8 = '')
        {
            ...
            if (empty($_var_7)) {
                $_var_10 = $_W['siteroot'] . 'addons/sea/plugin/yunpay/notify.php';
                $_var_11 = $_W['siteroot'] . "app/index.php?i={$_W['uniacid']}&c=entry&m=sea&do=order&p=pay&op=returnyunpay&openid=" . $_var_8;
            } else {
                $_var_10 = $_W['siteroot'] . 'addons/sea/plugin/yunpay/notify.php';
                $_var_11 = $_W['siteroot'] . "app/index.php?i={$_W['uniacid']}&c=entry&m=sea&do=member&p=recharge&op=returnyunpay&openid=" . $_var_8;
            }
            $_var_12 = $_var_9;
