...
global $_W, $_GPC;
$uniacid = $_W['uniacid'];
require_once '../addons/sea/plugin/pingpp/init.php';
...
$order_info = pdo_fetch('select * from ' . tablename('sea_order') . ' where ordersn=:ordersn and uniacid=:uniacid and openid=:openid limit 1', array('ordersn' => $orderNo, ':uniacid' => $uniacid, ':openid' => $input_data['openid']));
