...
$parent_category = pdo_fetch('select id,parentid,name,level from ' . tablename('sea_category') . ' where id=:id 
    and uniacid=:uniacid limit 1', array(':id' => $current_category['parentid'], ':uniacid' => $_W['uniacid']));
$args = array('pagesize' => 20, 'page' => $_GPC['page'], 'isnew' => $_GPC['isnew'], 'ishot' => $_GPC['ishot'], 'isrecommand' => $_GPC['isrecommand'], 'isdiscount' => $_GPC['isdiscount'], 'istime' => $_GPC['istime'], 'keywords' => $_GPC['keywords'], 'pcate' => $_GPC['pcate'], 'ccate' => $_GPC['ccate'], 'tcate' => $_GPC['tcate'], 'order' => $_GPC['order'], 'by' => $_GPC['by']);
...
$keywords = !empty($args['keywords']) ? trim($args['keywords']) : '';
if (!empty($keywords)) {//搜索存cookie
