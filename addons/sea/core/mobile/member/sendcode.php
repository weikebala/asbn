...
if ($op == 'sendcode') {
    ...
    $info = pdo_fetch('select * from ' . tablename('sea_member') . ' where mobile=:mobile and pwd!="" and uniacid=:uniacid limit 1', array(':uniacid' => $_W['uniacid'], ':mobile' => $mobile));
    if (!empty($info)) {
    ...
    if ($op == 'forgetcode') {
        ...
        if ($op == 'bindmobilecode') {
            ...
            $info = pdo_fetch('select * from ' . tablename('sea_member') . ' where mobile=:mobile and pwd!="" and uniacid=:uniacid and isbindmobile=1 limit 1', array(':uniacid' => $_W['uniacid'], ':mobile' => $mobile));
            if (!empty($info)) {
