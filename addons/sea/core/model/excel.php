...
class Sz_DYi_Excel
{
    ...
    function export($list, $params = array())
    {
        ...
        $excel = new PHPExcel();
        $excel->getProperties()->setCreator("海软商城")->setLastModifiedBy("海软商城")->setTitle("Office 2007 XLSX Test Document")->setSubject("Office 2007 XLSX Test Document")->setDescription("Test document for Office 2007 XLSX, generated using PHP classes.")->setKeywords("office 2007 openxml php")->setCategory("report file");
		...
		ob_end_clean();//sunchengquan 20160530
    ...
    public function import($excefile)
    {
        ...
        $path = IA_ROOT . "/addons/sea/data/tmp/";
        if (!is_dir($path)) {
            load()->func('file');
            mkdirs($path, '0777');
        }
