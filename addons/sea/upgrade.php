...
if(!pdo_fieldexists('sea_creditshop_log', 'storeid')) {
	pdo_query("ALTER TABLE ".tablename('sea_creditshop_log')." ADD    `storeid` int(11) DEFAULT '0';");
}
if(!pdo_fieldexists('sea_creditshop_log', 'realname')) {
	pdo_query("ALTER TABLE ".tablename('sea_creditshop_log')." ADD   `realname` varchar(255) DEFAULT '';");
}
 if(!pdo_fieldexists('sea_creditshop_log', 'mobile')) {
	pdo_query("ALTER TABLE ".tablename('sea_creditshop_log')." ADD   `mobile` varchar(255) DEFAULT '';");
}
 if(!pdo_fieldexists('sea_order', 'ordersn2')) {
	pdo_query("ALTER TABLE ".tablename('sea_order')." ADD    `ordersn2` int(11) DEFAULT '0';");
}
if(!pdo_fieldexists('sea_order', 'changeprice')) {
	pdo_query("ALTER TABLE ".tablename('sea_order')." ADD    `changeprice` decimal(10,2) DEFAULT '0.00';");
}
if(!pdo_fieldexists('sea_order', 'changedispatchprice')) {
	pdo_query("ALTER TABLE ".tablename('sea_order')." ADD    `changedispatchprice` decimal(10,2) DEFAULT '0.00';");
}
if(!pdo_fieldexists('sea_order', 'oldprice')) {
	pdo_query("ALTER TABLE ".tablename('sea_order')." ADD    `oldprice` decimal(10,2) DEFAULT '0.00';");
}
if(!pdo_fieldexists('sea_order', 'olddispatchprice')) {
	pdo_query("ALTER TABLE ".tablename('sea_order')." ADD    `olddispatchprice` decimal(10,2) DEFAULT '0.00';");
}
 if(!pdo_fieldexists('sea_order', 'isvirtual')) {
	pdo_query("ALTER TABLE ".tablename('sea_order')." ADD   `isvirtual` tinyint(3) DEFAULT '0';");
}
 if(!pdo_fieldexists('sea_order_goods', 'changeprice')) {
	pdo_query("ALTER TABLE ".tablename('sea_order_goods')." ADD    `changeprice` decimal(10,2) DEFAULT '0.00';");
}
 if(!pdo_fieldexists('sea_order_goods', 'oldprice')) {
	pdo_query("ALTER TABLE ".tablename('sea_order_goods')." ADD    `oldprice` decimal(10,2) DEFAULT '0.00';");
}
 if(!pdo_fieldexists('sea_order_goods', 'commissions')) {
	pdo_query("ALTER TABLE ".tablename('sea_order_goods')." ADD    `commissions` text;");
}
 if(!pdo_fieldexists('sea_goods', 'ednum')) {
	pdo_query("ALTER TABLE ".tablename('sea_goods')." ADD    `ednum` int(11) DEFAULT '0';");
}
 if(!pdo_fieldexists('sea_goods', 'edmoney')) {
	pdo_query("ALTER TABLE ".tablename('sea_goods')." ADD     `edmoney` decimal(10,2) DEFAULT '0.00';");
}
 if(!pdo_fieldexists('sea_goods', 'edareas')) {
	pdo_query("ALTER TABLE ".tablename('sea_goods')." ADD      `edareas` text;");
}
 if(!pdo_fieldexists('sea_member', 'fixagentid')) {
	pdo_query("ALTER TABLE ".tablename('sea_member')." ADD      `fixagentid` tinyint(3) DEFAULT '0';");
}
 if(!pdo_fieldexists('sea_poster', 'reccouponid')) {
	pdo_query("ALTER TABLE ".tablename('sea_poster')." ADD      `reccouponid` int(11) DEFAULT '0';");
}
 if(!pdo_fieldexists('sea_poster', 'reccouponnum')) {
	pdo_query("ALTER TABLE ".tablename('sea_poster')." ADD        `reccouponnum` int(11) DEFAULT '0';");
}
 if(!pdo_fieldexists('sea_poster', 'subcouponid')) {
	pdo_query("ALTER TABLE ".tablename('sea_poster')." ADD         `subcouponid` int(11) DEFAULT '0';");
}
 if(!pdo_fieldexists('sea_poster', 'subcouponnum')) {
	pdo_query("ALTER TABLE ".tablename('sea_poster')." ADD         `subcouponnum` int(11) DEFAULT '0';");
}
 if(!pdo_fieldexists('sea_plugin', 'category')) {
	pdo_query("ALTER TABLE ".tablename('sea_plugin')." ADD         `category` varchar(255) DEFAULT '0';");
}
/**/
 if(!pdo_fieldexists('sea_goods', 'deduct2')) {
	pdo_query("ALTER TABLE ".tablename('sea_goods')." ADD         `deduct2` decimal(10,2) DEFAULT '0.00';");
}
 if(!pdo_fieldexists('sea_order', 'couponid')) {
	pdo_query("ALTER TABLE ".tablename('sea_order')." ADD         `couponid` int(11) DEFAULT '0';");
}
 if(!pdo_fieldexists('sea_order', 'couponprice')) {
	pdo_query("ALTER TABLE ".tablename('sea_order')." ADD         `couponprice` decimal(10,2) DEFAULT '0.00';");
}
 if(!pdo_fieldexists('sea_creditshop_goods', 'goodstype')) {
	pdo_query("ALTER TABLE ".tablename('sea_creditshop_goods')." ADD      `goodstype` tinyint(3) DEFAULT '0';");
}
 if(!pdo_fieldexists('sea_creditshop_goods', 'couponid')) {
	pdo_query("ALTER TABLE ".tablename('sea_creditshop_goods')." ADD      `couponid` int(11) DEFAULT '0';");
}
 if(!pdo_fieldexists('sea_member_log', 'gives')) {
	pdo_query("ALTER TABLE ".tablename('sea_member_log')." ADD      `gives` decimal(10,2) DEFAULT NULL;");
}
 if(!pdo_fieldexists('sea_commission_level', 'downcount')) {
	pdo_query("ALTER TABLE ".tablename('sea_commission_level')." ADD      `downcount` int(11) DEFAULT '0';");
}
 if(!pdo_fieldexists('sea_commission_level', 'ordercount')) {
	pdo_query("ALTER TABLE ".tablename('sea_commission_level')." ADD      `ordercount` int(11) DEFAULT '0';");
}

$sql = "
CREATE TABLE IF NOT EXISTS ".tablename('sea_coupon'). " (
...
CREATE TABLE IF NOT EXISTS ".tablename('sea_coupon_category'). " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS ".tablename('sea_coupon_data'). " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS ".tablename('sea_coupon_guess'). " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `couponid` int(11) DEFAULT '0',
  `openid` varchar(255) DEFAULT '',
...
CREATE TABLE IF NOT EXISTS ".tablename('sea_coupon_log'). " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS ".tablename('sea_postera'). " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `type` tinyint(3) DEFAULT '0' COMMENT '1 首页 2 小店 3 商城 4 自定义',
...
CREATE TABLE IF NOT EXISTS ".tablename('sea_postera_log'). " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `openid` varchar(255) DEFAULT '',
  `posterid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS ".tablename('sea_postera_qr'). " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `acid` int(10) unsigned NOT NULL,
  `openid` varchar(100) NOT NULL DEFAULT '',
  `posterid` int(11) DEFAULT '0',
