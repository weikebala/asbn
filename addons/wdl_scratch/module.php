...
class wdl_scratchModule extends WeModule {
    ...
    public function fieldsFormDisplay($rid = 0) {
        ...
        if (!$reply) {
            ...
            $reply = array(
             "title"=>"刮刮卡活动开始了!",
			  "start_picurl"=>"../addons/wdl_scratch/style/image/activity-scratch-card-start.jpg",
			  "description"=>"欢迎参加刮刮卡活动",
			  "repeat_lottery_reply"=>"亲，继续努力哦~~",
			  "ticket_information"=>"兑奖请联系我们,电话: 13888888888",
			  "starttime"=>$now,
		      "endtime"=>strtotime(date("Y-m-d H:i",$now + 7*24*3600)),
			  "end_theme"=>"刮刮卡活动已经结束了",
			  "end_instruction"=>"亲，活动已经结束，请继续关注我们的后续活动哦~",
			  "end_picurl"=>"../addons/wdl_scratch/style/image/activity-scratch-card-end.jpg",
			  "most_num_times"=>1,
			  "number_times"=>1,
			  "probability"=>0,
			  "award_times"=>1,
			  ...
			  "share_title"=>"欢迎参加刮刮卡活动",
			  "share_desc"=>"亲，欢迎参加刮刮卡抽奖活动，祝您好运哦！！ 亲，需要绑定账号才可以参加哦",
			  "share_text"=>"&lt;p&gt;1. 关注微信公众账号\"()\"&lt;/p&gt;&lt;p&gt;2. 发送消息\"刮刮卡\", 点击返回的消息即可参加&lt;/p&gt;",
            );
        }
    ...
    public function ruleDeleted($rid) {
        pdo_delete('wdl_scratch_award', array('rid' => $rid));
        pdo_delete('wdl_scratch_reply', array('rid' => $rid));
        pdo_delete('wdl_scratch_fans', array('rid' => $rid));
    }
