...
class MonUtil
{
	...
	public static $IMG_LIST_BG = 1;



	/**
	 * author: codeMonkey QQ:45300551
	 * @param $url
	 * @return string
	 */
	...
	public static function defaultImg($img_type, $timeline ='')
	{
		switch ($img_type) {
			//首页
			case MonUtil::$IMG_LIST_BG:
				if (!empty($timeline)&&!empty($timeline['list_bg'])) {
					return MonUtil::getpicurl($timeline['list_bg']);
				}
				$img_name = "list_4_bg.jpg";
				break;

		}
		return "../addons/mon_timeline/images/" . $img_name;
