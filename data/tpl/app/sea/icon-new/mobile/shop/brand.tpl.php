...
<title><?php  if(empty($current_category)) { ?>全部品牌<?php  } else { ?><?php  echo $current_category['name'];?><?php  } ?></title>
<style type="text/css">
...
<script id='tpl_goods_list' type='text/html'>
    ...
    <?php  if(is_array($brand)) { foreach($brand as $g) { ?>
    ...
    <div class="good" data-goodsid='<?php  echo $g['id'];?>' data-mid=<?php  echo $member_shop['id'];?> style="position:relative;">
		<div class="goods-img">
       <a href="<?php  echo $this->createMobileUrl('shop/brandlist')?>&bid=<?php  echo $g['id'];?>"> <img src="<?php  echo $g['thumb'];?>"></a>
		</div>
    ...
    require(['tpl', 'core'], function (tpl, core) {
      ...
      function getGoods() {
        ...
        function getGoodsMore() {
            ...
            core.json('shop/brand', args, function (json) {
