    ...
    <div class="main">
        ...
        <div class='page'>
            ...
            <div class="topbar">
                ...
                <div class="search" onclick="window.location.href='http://<?php  echo $_SERVER['SERVER_NAME'];?>/app/index.php?i=<?php  echo $_W['uniacid'];?>&c=entry&do=shop&m=sea&p=search'"><i class="iconfont icon-search" style="font-size: 22px"></i></div>
            </div>
            <div class="sort_list sort_listnew">
...
<script id='tpl_category_list' type='text/html'>
     <div class="category">
        <div class="title category_item" data-name='全部商品'><i class="iconfont icon-list-ul"></i> 全部分类<i class="fa fa-angle-left close" style="font-size:26px; float:right; line-height:44px; margin-right:20px;"></i></div>
        <div class="all">
