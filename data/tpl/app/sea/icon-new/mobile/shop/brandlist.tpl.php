...
<script id='tpl_main' type='text/html'>
    ...
    <div class="main">
        ...
        <div class='page'>
            ...
            <div>
                <img style="width: 20%;height:90px;float: left;" src="/attachment/<?php  echo $current_brand['thumb'];?>">
                <div class="goods" style=" color:#666;float: left;width: 78%;height: 90px;overflow: scroll">
                    <?php  echo $current_brand['description'];?>
                </div>
            </div>
            <?php  } ?>
