...
<script id='tpl_index' type='text/html'>
    ...
    <div class="top">
        <div class="bgimg"><img src="<?php  if($this->yzShopSet['img']) { ?><?php  echo $_W['siteroot'] . "attachment/" . $this->yzShopSet['img']?><?php  } else { ?>../addons/sea/template/mobile/default/static/images/bg.jpg<?php  } ?>"></div>
<!--        <div class="list" onclick="location.href='<?php  echo $this->createMobileUrl('shop/category')?>'"><i class="fa fa-list"></i> 分类</div>-->
        <div class="topbar">
            
            <div class="logo"><img src="<?php  if($this->yzShopSet['logo']) { ?><?php  echo $_W['siteroot'] . "attachment/" . $this->yzShopSet['logo']?><?php  } else { ?>../addons/sea/template/mobile/default/static/images/logo.png<?php  } ?>"></div>
            <div class="shop_name"><?php  echo $this->yzShopSet['name']?></div>
            <div class="menu">
...
<script id='tpl_goods_list' type='text/html'>
    ...
    <%each goods as g%>
    <div class="good" data-goodsid='<%g.id%>' data-mid='<%mid%>'>
 ...
 <script id='tpl_search_list' type='text/html'>
     <ul>
     <%each list as value%>
        <li><i class="fa fa-angle-right"></i> <a href="<?php  echo $this->createMobileUrl('shop/detail')?>&id=<%value.id%>&id=<%value.id%>"><%%></a></li>
        <%/each%>
    </ul> 
</script>
    ...
    $('.good img').each(function(){
                $(this).height($(this).width());
                        ...
                        $('.good').unbind('click').click(function(){
                            var url = core.getUrl('shop/detail',{id:$(this).data('goodsid') });
