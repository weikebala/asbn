    ...
    <div class="main">
        ...
        <div class='page'>
            ...
            <div class="topbar">
                ...
                <div class="name"><?php  if(empty($current_brand)) { ?>全部商品<?php  } else { ?><?php  echo $current_brand['name'];?>品牌<?php  } ?></div>

            </div>
			<div class="goods">
				<img style=" width:100%;" src="/attachment/<?php  echo $current_brand['thumbs'];?>">
			</div>
...
.pp-xlarr-ico{
    background: url(/addons/sea/static/images/imgs_03.png) no-repeat;
    width: 21px;
    height: 13px;
    display:inline-block;
...
.good{
    ...
    <div class="brand-info mgtop8">
        <div class="brand-info  brandInfo">
            <div class="brand-msg-left">
                <img style="" src="/attachment/<?php  echo $current_brand['thumb'];?>">
            </div>
            
            <div class="brand-msg-tit " >
            <?php  echo $current_brand['description'];?></div>
            <div class="pp-jt-xlk disnone" id="brandArr" data-type="hide">
            <a class="pp-xlarr-ico"  ></a> 
         </div>
        </div>
...
<script type="text/javascript">
    var B = {
        ...
        initHet:function(){
            ...
            var b=$("#brandArr");
            if(s.height()>90){
                b.show().attr("data-type","show");
                t.addClass("hd-brand")
            }
        },
        initArr:function(){
            $("#brandArr").on("click",function(){
                var t = $(this);
                var attr=t.attr("data-type");
                var b=$(".brandInfo");
                if(t.hasClass("arrshow")){
                    b.addClass("hd-brand");
                    t.removeClass("arrshow");
                    t.find("a").removeClass("brand-show-arr");
                }else{
                    if(attr=="show"){
                        t.find("a").addClass("brand-show-arr");
                        b.removeClass("hd-brand");
                        t.addClass("arrshow");
                    }else{
                        return false;
                    }
...
<script id='tpl_goods_list' type='text/html'>
  <form action="" method="get" id="goodsform">
    ...
    <div class="good" data-goodsid='<?php  echo $g['id'];?>' data-mid=<?php  echo $member_shop['id'];?> style="position:relative;">
        <?php  if($g['total']<=0) { ?><div class="nostock"><img src="../addons/sea/template/mobile/default/static/images/salez.png"></div><?php  } ?>
		<div class="goods-img">
      ...
      function getGoods() {
        ...
        function bindEvents() {
            ...
            $('.good').unbind('click').click(function () {
				url = core.getUrl('shop/detail', {id: $(this).data('goodsid'),my:'<?php  echo $_GPC['my'];?>'});
					if (url.indexOf('&mid') > 0) {
                                location.href = url;
                            }else{
                                location.href = url+'&mid='+$(this).data('mid');
                            }
