...
<style type="text/css">
   ...
   .main .category .all p.category_item { padding-top:10px;}
    ...
    .main .page .goods .good .nostock { position: absolute;bottom:-30px;right:16%; width:30%;height:30%;z-index: 999;}
    ...
    <div class="main">
        ...
        <div class='page'>
            ...
            <div class="topbar">
                ...
                <div class="search" onclick="window.location.href='http://<?php  echo $_SERVER['SERVER_NAME'];?>/app/index.php?i=<?php  echo $_W['uniacid'];?>&c=entry&do=shop&m=sea&p=search'"><i class="fa fa-search"></i></div>
...
<script id='tpl_category_list' type='text/html'>
     <div class="category">
		...
		<a href="<?php  echo $this->createMobileUrl('shop/list')?>&pcate=<%parent.id%>">
         <p class='category_item' style=" color:#fff;"><i class="fa fa-angle-double-right"></i> <%parent.name%></p>                   
		 </a>
