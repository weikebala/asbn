...
<div class="detail_price" >
    ...
    <div class="price">
        ...
        <%if order.customs_price>0%>
        <div class="line">税费:<span>+￥<span class='customs_price'><%order.customs_price%></span></span></div>
        <%/if%>
        <%if order.danpindeduct>0%>
        <div class="line">单品满减:<span>-￥<span class='danpindeduct'><%order.danpindeduct%></span></span></div>
        <%/if%>
        <%if order.deductenough>0%>
        <div class="line">订单满减:<span>-￥<span class='deductenough'><%order.deductenough%></span></span></div>
        <%/if%>
        <%if order.deductenoughzk>0%>
        <div class="line">订单满额折扣:<span>-￥<span class='deductenoughzk'><%order.deductenoughzk%></span></span></div>
        <%/if%>
