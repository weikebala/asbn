...
<script id='refund_edit' type='text/html'>
 ...
 <div class="refund_main" >
        ...
        <div class="line r-group" <%if refund.rtype=='2'%>style="display:none;"<%/if%>><div class="label"><span class="re-g">退款</span>金额</div><div class="info"><div class="inner"><input type="text" id="price" value="<%order.refundprice%>" readonly/></div></div></div>
        ...
        <?php  if(!empty($tradeset['refundcontent'])) { ?>
            <div class="line r-group" style="color: #666; height: auto; overflow: hidden"><div class="label"></div><div class="inner" style="color: #ef4f4f;"><?php  echo $tradeset['refundcontent'];?></div></div>
        <?php  } ?>
...
//                             bindEdit();
                        ...
                        $('#refund_express').click(function(){
                            location.href = core.getUrl('order/refundexpress',{id:'<?php  echo $_GPC['orderid'];?>'});
                        });
