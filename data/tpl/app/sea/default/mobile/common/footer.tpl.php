    ...
    <?php  } else { ?>
        ...
        <footer id="footer-nav">
                        <ul class="menu-list" style="margin:0">
                            ...
                            <li <?php  if($footer_current=='seconds') { ?>class='active'<?php  } ?>><a href="<?php  echo $this->footer['seconds']['url']?>"><i class="fa fa-<?php  echo $this->footer['second']['ico']?>"></i><span><?php  echo $this->footer['seconds']['text']?></span></a></li>
