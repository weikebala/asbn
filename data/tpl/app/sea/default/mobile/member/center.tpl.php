...
<style type="text/css">
    ...
    .header {height: auto; width:100%; padding:0px; background: url(../addons/sea/template/mobile/default/static/images/bg2.png) 0 0 no-repeat;background-size: 100% 100%;}
...
<div class="cart">
    ...
    <a href="<?php  echo $this->createMobileUrl('member/bindmobile')?>"><div class="list1" style="margin:0px; border-bottom:0px;"><i class="fa fa-mobile" style="color:#f10;"></i>绑定手机<i class="fa fa-angle-right" style="color:#999; font-size:26px; float:right; line-height:44px;"></i></div></a>
    <?php  } ?>
</div>
<div class="cart">
    <?php  if(p('supplier')) { ?>
    <?php  if($supplier_set['switch'] == 1) { ?>
        <a href="<?php  echo $this->createPluginMobileUrl('supplier/af_supplier')?>"><div class="list1" style="margin:0px; border-bottom:0px;"><i class="fa fa-pencil" style="color:#f10;"></i>供应商申请<i class="fa fa-angle-right" style="color:#999; font-size:26px; float:right; line-height:44px;"></i></div></a>
    <?php  } ?>
    <?php  } ?>
    <?php  if($pluginbonus) { ?>
        <?php  if(!empty($bonus_set['start'])) { ?>
            <?php  if(empty($bonus_set['bonushow'])) { ?>
            <a href="<?php  echo $this->createPluginMobileUrl('bonus/index')?>"><div class="list1" style="margin:0px; border-bottom:0px;"><i class="fa fa-money" style="color:#f10;"></i><?php echo empty($bonus_set['texts']['center']) ? "分红中心" : $bonus_set['texts']['center'];?><i class="fa fa-angle-right" style="color:#999; font-size:26px; float:right; line-height:44px;"></i></div></a>
            <?php  } ?>
        <?php  } ?>
    <?php  } ?>
    <?php  if(p('return')) { ?>
    <a href="<?php  echo $this->createPluginMobileUrl('return/return_log')?>"><div class="list1" style="margin:0px; border-bottom:0px;"><i class="fa fa-money" style="color:#f10;"></i>全返明细<i class="fa fa-angle-right" style="color:#999; font-size:26px; float:right; line-height:44px;"></i></div></a> 
    <?php  } ?>
</div>
<?php  if($hascoupon) { ?>
<div class="cart">
...
<div class="cart">
	...
	<%if (shopset.switch == 1) && (shopset.isintegral ==1 || shopset.isexpense ==1 || shopset.iscommission ==1 || shopset.isfans ==1 || shopset.issales ==1 || shopset.istuiguang ==1)%>
	<a href="<?php  echo $this->createPluginMobileUrl('commission/yongjin')?>"><div class="list1" style="margin:0px; border-bottom:0px;"><i class="fa fa-thumbs-o-up" style="color:#cc6;"></i><%shopset.phbname%><i class="fa fa-angle-right" style="color:#999; font-size:26px; float:right; line-height:44px;"></i></div></a>
	<%/if%>
	</div>
...
<?php  if(!is_weixin()) { ?>
<a href="<?php  echo $this->createMobileUrl('member/logout')?>"><div class="list1"><i class="fa fa-sign-out" style="color:#99C"></i>退出<i class="fa fa-angle-right" style="color:#999; font-size:26px; float:right; line-height:44px;"></i></div></a>
<?php  } ?>
