		...
		<li class="list-group-item">
			<div>
						...
						<div class="col-sm-9 col-xs-12">
							...
							<div class="help-block" style="margin-top:10px;">
								<ol style="margin-top:10px;">
									...
									<?php  if(IMS_FAMILY != 'x') { ?><li>具体请<a href="http://www.iseasoft.cndocs/#api" target="_blank">查看“自定义接口回复”文档</a></li><?php  } ?>
								</ol>
							</div>
						</div>
					</div>
				...
				<div class="form-group" ng-show="item.type == '0'">
					...
					<div class="col-sm-9 col-xs-12">
						<select name="apilocal" class="form-control" ng-model="item.apilocal"><option value="">请选择本地文件</option><?php  if(is_array($apis)) { foreach($apis as $file) { ?><option <?php  if($row['apilocal'] == $file) { ?> selected="selected"<?php  } ?> value="<?php  echo $file;?>"><?php  echo $file;?></option><?php  } } ?></select>
						<div class="help-block" style="margin-top:10px;">
							<ol style="margin-top:10px;">
