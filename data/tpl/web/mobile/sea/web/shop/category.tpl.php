        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
               ...
               <div class="form-group">
                ...
                <?php  if(empty($parentid)) { ?>
                <div class="form-group">
                    <label class="col-xs-12 col-sm-3 col-md-2 control-label">首页分类活动链接</label>
                    <div class="col-sm-9 col-xs-12">
                        <?php if( ce('shop.category' ,$item) ) { ?>
                        <input type="text" name="activity_url" class="form-control" value="<?php  echo $item['activity_url'];?>" />
                        <?php  } else { ?>
                        <div class='form-control-static'><?php  echo $item['activity_url'];?></div>
                        <?php  } ?>
                    </div>
                </div>
                <?php  } ?>
