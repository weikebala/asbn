            ...
            <div class='panel-body'>  
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9 col-xs-12">
                        ...
                        <span class='help-block'>请到 <a href='https://meiqia.com/' target='_blank'>美恰</a> 获取聊天连接地址<br>如:https://static.meiqia.com/dist/standalone.html?eid=11419
                        <?php  } else { ?>
			 ...
			 <textarea name="shop[diycode]" class="form-control richtext" cols="70" rows="5"><?php  echo $set['shop']['diycode'];?></textarea>
                ...
                <div class="form-group">
                    <label class="col-xs-12 col-sm-3 col-md-2 control-label">热搜关键词</label>
                    <div class="col-sm-9 col-xs-12">
                        <input type="text" name="shop[hotkeyword]" class="form-control" value="<?php  echo $set['shop']['hotkeyword'];?>" />
                        <span class='help-block'>多个关键词半角逗号(,)隔开</span>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-xs-12 col-sm-3 col-md-2 control-label">首页分类按钮字样</label>
                    <div class="col-sm-9 col-xs-12">
                        <input type="text" name="shop[btnname]" class="form-control" value="<?php  echo $set['shop']['btnname'];?>" />
                    
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-xs-12 col-sm-3 col-md-2 control-label">首页分类按钮链接</label>
                    <div class="col-sm-9 col-xs-12">
                        <input type="text" name="shop[btnlink]" class="form-control" value="<?php  echo $set['shop']['btnlink'];?>" />
