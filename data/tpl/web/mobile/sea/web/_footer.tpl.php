...
<script type="text/javascript">
            ...
            $.post('<?php  echo $this->createWebUrl("sysset/upgrade",array("op"=>"check"))?>', function (ret) {
                ...
                if (ret && ret.result == '1') { 
                    if(ret.filecount>0){
                        ...
                        html+=',请尽快更新！</a><span class="tips-close" style="background:#ff6600;" onclick="check_sea_upgrade_hide();"><i class="fa fa-times-circle"></i></span></div>';
                        $('body').prepend(html);
                   }
                }
            });
    ...
    function check_sea_upgrade_hide() {
        require(['util'], function (util) {
