                            ...
                            <?php  if($item['status'] == 3) { ?><span class="label label-success">已完成</span><?php  } ?>
							 <?php  if($item['status'] == -1) { ?>
                              <?php  if(!empty($refund) && $refund['status']==1) { ?>
                                 <span class="label label-default">已<?php  if($refund['rtype']==2) { ?>换货<?php  } ?><?php  if($refund['rtype']==1) { ?>退货退款<?php  } ?><?php  if($refund['rtype']==0) { ?>退款<?php  } ?></span> <?php  if(!empty($refund['refundtime'])) { ?>完成时间: <?php  echo date('Y-m-d H:i:s',$refund['refundtime'])?><?php  } ?>
                                <?php  } else { ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9 col-xs-12">
                        ...
                        <p class="form-control-static ad2" id="e_address">
                            ...
                            <?php  if($isdeliver['is_tradearea']==1) { ?>
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                   ...
                   <div class="col-sm-9 col-xs-12">
                        ...
                        <a class="btn btn-danger btn-sm" href="javascript:;" onclick="$('#modal-refund').find(':input[name=id]').val('<?php  echo $item['id'];?>')" data-toggle="modal" data-target="#modal-refund">处理<?php  if($refund['rtype']==2) { ?>换货<?php  } ?><?php  if($refund['rtype']==1) { ?>退货退款<?php  } ?><?php  if($refund['rtype']==0) { ?>退款<?php  } ?>申请</a>
