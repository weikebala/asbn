                               ...
                               <!--已付款-->
                                ...
                                <?php  if(!empty($item['addressid']) ) { ?>
                                      <!--快递 发货-->
                                        ...
                                        <input class='addressdata' type='hidden' value='<?php  echo json_encode($item['addressdata'])?>'  />
                                        <input class='itemid'  type='hidden' value="<?php  echo $item['id'];?>"  />
                                        <input class='order_privinc'  type='hidden' value="<?php  echo $item['province'];?>"  />
                                        <input class='order_city'  type='hidden' value="<?php  echo $item['city'];?>"  />
                                        <input class='order_area'  type='hidden' value="<?php  echo $item['area'];?>"  />
                                        <a class="btn btn-primary btn-sm" href="javascript:;" onclick="send(this)" data-toggle="modal" data-target="#modal-confirmsend">确认发货</a><br/>
                                        </div>
                                        <?php  } ?>
                                <?php  } else { ?>
