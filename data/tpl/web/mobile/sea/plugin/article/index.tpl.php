...
<link href="../addons/sea/plugin/article/template/imgsrc/article.css" rel="stylesheet">
<script type="text/javascript" src="../addons/sea/plugin/article/template/imgsrc/jquery.json.js"></script>
    ...
    $(".addbtn").click(function(){
        ...
        if(num<5){
            var html = '<div class="adv">';
                  ...
                  html+='<div class="img"><img src="../addons/sea/plugin/article/template/imgsrc/nochooseimg.jpg" data-id="PAI-'+id+'" /></div>';
                  html+='<div class="info">';
                 ...
                 <div class="modal-body tab-content">
                     <div role="tabpanel" class="tab-pane link_system active" id="link_system">
                         <div class="mylink-con">
                            ...
                            <div class="btn btn-default mylink-nav" data-href="<?php  echo $this->createMobileUrl('plugin/commission')?>">加盟中心</div>
    ...
    <div class="fart-preview">
        ...
        <div class="main">
            ...
            <div class="fart-rich-sift product" <?php  if($article['product_advs_type']!=0) { ?>style="display:block;"<?php  } ?>>
                ...
                <div class="fart-rich-sift-img"><img src="../addons/sea/plugin/article/template/imgsrc/img01.jpg"></div>
                    ...
                    <div class="con2">
                        ...
                        <div id="tabcon">
                            ...
                            <div n="2" class="con">
                                ...
                                <div class="itembox" title="底部内容版式"><section><section style="max-width: 100%; margin: 2px; padding: 0px;"><section style="max-width: 100%;margin-left:1em; line-height: 1.4em;"><span style="font-size:14px"><strong style="color:rgb(62, 62, 62); line-height:32px; white-space:pre-wrap"><span style="background-color:rgb(86, 159, 8); border-radius:5px; color:rgb(255, 255, 255); padding:4px 10px" class="bc">关于文章编辑器</span></strong></span></section><section style="font-size: 1em; max-width: 100%; margin-top: -0.7em; padding: 10px 1em; border: 1px solid rgb(192, 200, 209); border-radius: 0.4em; color: rgb(51, 51, 51); background-color: rgb(239, 239, 239);"><p><span placeholder="提供非常好用的微信文章编辑工具。">非常好用的在线图文编辑工具，欢迎将XXX商城推荐给您的朋友，将他/她从痛苦的编辑中解脱出来。</span></p><p><br></p><p style="text-align: center;"><img alt="" src="../addons/sea/plugin/article/template/imgsrc/itembox/0003.jpg" width="100%"></p></section></section></section></div>
                            ...
                            <div n="7" class="con">
                                ...
                                <div class="itembox" title="时间地点"><section><section class="bdc" style="background-color: white; border: 1px solid #00BBEC; box-shadow: rgb(165, 165, 165) 0em 1em 0.1em -0.6em; line-height: 1.6em;"><section class="bc" style="padding: 1em; text-align: center; font-size: 1.4em; font-weight: bold; line-height: 1.4em; color: white;background-color: #00BBEC; ">请输入名称</section><section style="text-align: left; margin-top: 1.5em;"><img style="vertical-align: top; margin-left: 1em; width: 30px;" src="../addons/sea/plugin/article/template/imgsrc/itembox/0001.png"><section style="display: inline-block; width: 40%; margin-left: 0.5em; padding: 0.2em;">时间</section></section><section style="text-align: left; margin-top: 1em;"><img style="vertical-align: top; margin-left: 1em; width: 30px;" src="../addons/sea/plugin/article/template/imgsrc/itembox/0002.png"><section style="display: inline-block; width: 40%; margin-left: 0.5em; padding: 0.2em;">地点</section></section><br><br><br></section></section></div>
                            ...
                            <div id="advs">
                                <?php  if(!empty($aid) && !empty($advs)) { ?>
                                    <?php  if(is_array($advs)) { foreach($advs as $i=>$adv) { ?>
                                        <div class="adv">
                                            <div class="del">×</div>
                                            <div class="img"><img src="<?php  if(empty($adv['img'])) { ?>../addons/sea/plugin/article/template/imgsrc/nochooseimg.jpg<?php  } else { ?><?php  echo $adv['img'];?><?php  } ?>" data-id="PAI-<?php  echo time()+$i+1?>" /></div>
                                            <div class="info">
    ...
    <div class='panel-body'>
        <div class="form-group" style="padding-top:20px;">
            ...
            <div class="col-sm-9 col-xs-12">
                ...
                <div class="help-block">公众平台模板消息编号: OPENTM200605630 (同加盟 任务处理通知 一个模板id)</div>
            </div>
        </div>
