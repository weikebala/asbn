...
<form <?php if(cv('commission.apply.check|commission.apply.pay|commission.apply.cancel')) { ?>action="" method='post'<?php  } ?> class='form-horizontal'>
    ...
    <div style='float:left;height:auto;overflow: hidden'>
        ...
        <p><b>加盟等级:</b>  <?php  echo $agentLevel['levelname'];?> (
        ...
        <?php  } ?>
            <?php if(cv('commission.apply.pay')) { ?>
             ...
             <input type="submit" name="submit_pay" value="打款到余额账户" class="btn btn-primary col-lg-1"  style='margin-left:10px;' onclick='return pay_credit()'/>
			  <input type="submit" name="submit_alipay" value="打款到支付宝" class="btn btn-primary col-lg-1" style='margin-left:10px;' onclick='return pay_alipay()'/>
              <?php  } else { ?>
