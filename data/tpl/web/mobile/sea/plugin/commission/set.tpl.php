    ...
    <div class='panel panel-default'>
        ...
        <div class='panel-body'>
            ...
            <div class="form-group">
                <label class="col-xs-12 col-sm-3 col-md-2 control-label">加盟层级</label>
                <div class="col-sm-4">
                    <select  class="form-control" name="setdata[level]">
                        <option value="0" <?php  if(empty($set['level'])) { ?>selected<?php  } ?>>不开启加盟机制</option>
                        <option value="1" <?php  if($set['level']==1) { ?>selected<?php  } ?>>一级加盟</option>
                        <option value="2" <?php  if($set['level']==2) { ?>selected<?php  } ?> >二级加盟</option>
                        <option value="3" <?php  if($set['level']==3) { ?>selected<?php  } ?> >三级加盟</option>
                    </select>
                </div>
            </div> 
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                  ...
                  <span class='help-block'>新加入的加盟商（默认等级），采用此默认比例</span>
		<span class='help-block'>加盟佣金计算优先级： 商品固定佣金比例 > 加盟商等级佣金比例 >默认佣金比例</span>
                </div>
            </div>
             <div class="form-group">
                <label class="col-xs-12 col-sm-3 col-md-2 control-label">加盟内购</label>
                <div class="col-sm-9 col-xs-12">
                    ...
                    <span class='help-block'>开启加盟内购，加盟商自己购买商品，享受一级佣金，上级享受二级佣金，上上级享受三级佣金</span>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <select  class="form-control" name="setdata[culate_method]">
                        <option value="0" <?php  if(empty($set['culate_method'])) { ?>selected<?php  } ?>>实付款金额</option>
                        <option value="1" <?php  if($set['culate_method']==1) { ?>selected<?php  } ?>>商品原价</option>
                        <option value="2" <?php  if($set['culate_method']==2) { ?>selected<?php  } ?> >商品现价</option>
                        <option value="3" <?php  if($set['culate_method']==3) { ?>selected<?php  } ?> >商品成本价</option>
                        <option value="4" <?php  if($set['culate_method']==4) { ?>selected<?php  } ?> >商品利润（实付款金额-成本价）</option>
                    </select>
                </div>
            </div>
        </div>
        ...
        <div class='panel-body'>
           <div class="form-group">
                ...
                <div class="col-sm-9 col-xs-12">
                    ...
                    <span class='help-block'>首次点击分享连接： 可以自由设置加盟商条件</span>
                    <span class='help-block'>首次下单/首次付款： 无条件不可用</span>
                </div>
               </div>
            <div class="form-group">
                <label class="col-xs-12 col-sm-3 col-md-2 control-label">成为加盟商条件</label>
                <div class="col-sm-9 col-xs-12">
            ...
            <!-- Author:Y.yang Date:2016-04-08 Content:购买指定商品成为加盟商 -->
            <div class="form-group">
                <label class="col-xs-12 col-sm-3 col-md-2 control-label"></label>
                <div class="col-sm-6">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9 col-xs-12">
                    <label class="radio-inline"><input type="radio"  name="setdata[upgrade_by_good]" value="0" <?php  if($set['upgrade_by_good'] ==0) { ?> checked="checked"<?php  } ?> /> 否</label>
                    <label class="radio-inline"><input type="radio"  name="setdata[upgrade_by_good]" value="1" <?php  if($set['upgrade_by_good'] ==1) { ?> checked="checked"<?php  } ?> /> 是</label>
                </div>
            </div>
            <div class="form-group">
                <label class="col-xs-12 col-sm-3 col-md-2 control-label">加盟商必须完善资料</label>
                <div class="col-sm-9 col-xs-12">
                    ...
                    <span class="help-block">加盟商在加盟或提现时是否必须完善资料</span>
                </div>
            </div>
            <div class="form-group">
                <label class="col-xs-12 col-sm-3 col-md-2 control-label">成为加盟商是否需要审核</label>
                <div class="col-sm-9 col-xs-12">
                    ...
                    <span class="help-block">以上条件达到后，是否需要审核才能成为真正的加盟商</span>
                </div>
            </div>
            ...
            <div class="form-group">
                <label class="col-xs-12 col-sm-3 col-md-2 control-label">提现消费</label>
                <div class="col-sm-9 col-xs-12">
                    <input type="text" name="setdata[consume_withdraw]" class="form-control" value="<?php  echo $set['consume_withdraw'];?>"  />
                    <span class="help-block">钓鱼式营销，提现需先消费的金额，需订单完成后。</span>
                </div>
            </div>
           ...
           <div class="form-group">
                <label class="col-xs-12 col-sm-3 col-md-2 control-label">加盟等级说明连接</label>
                <div class="col-sm-9 col-xs-12">
                    <input type="text" name="setdata[levelurl]" class="form-control" value="<?php  echo $set['levelurl'];?>"  />
                    <span class="help-block">加盟等级说明连接</span>
                </div>
            </div>
             <div class="form-group">
                <label class="col-xs-12 col-sm-3 col-md-2 control-label">加盟商自选商品</label>
                <div class="col-sm-9 col-xs-12">
                    ...
                    <span class="help-block">是否允许加盟商自己的小店选择自己推广的产品,如果开启自选后，要单独禁用某个加盟商的自选权限，请到加盟商管理中设置</span>
                </div> 
           </div>
            <div class="form-group">
	 ...
	 <div class="form-group">
                <label class="col-xs-12 col-sm-3 col-md-2 control-label">加盟订单商品详情</label>
                <div class="col-sm-9 col-xs-12">
                    ...
                    <span class="help-block">加盟中心加盟订单是否显示商品详情</span>
                </div> 
           </div>
	       <div class="form-group">
                <label class="col-xs-12 col-sm-3 col-md-2 control-label">加盟订单购买者详情</label>
                <div class="col-sm-9 col-xs-12">
                    ...
                    <span class="help-block">加盟中心加盟订单是否显示购买者</span>
                </div> 
           </div>
           ...
           <div class="form-group">
                ...
                <div class="col-sm-9 col-xs-12">
                    <label class="radio-inline"><input type="radio"  name="setdata[remind_message]" value="0" <?php  if(empty($set['remind_message'])) { ?> checked="checked"<?php  } ?> /> 关闭</label>
                    <label class="radio-inline"><input type="radio"  name="setdata[remind_message]" value="1" <?php  if($set['remind_message'] ==1) { ?> checked="checked"<?php  } ?> /> 开启</label>
                    <span class="help-block">是否开启三级加盟订单消息提醒功能，不开启上级有消息</span>
                </div> 
           </div>
	...
	<div class='panel-body'>
		  <div class="form-group">
                ...
                <div class="col-sm-9 col-xs-12">
                    ...
                    <span class="help-block">加盟商默认等级名称，不填写默认“普通等级”</span>
                </div>
            </div> 
		<div class='panel-body'>
		  <div class="form-group">
                <label class="col-xs-12 col-sm-3 col-md-2 control-label">加盟商等级升级依据</label>
                <div class="col-sm-9 col-xs-12">
              
                        <label class="radio radio-inline" style="width:240px">
                              <input type="radio" name="setdata[leveltype]" value="0" <?php  if(empty($set['leveltype'])) { ?>checked<?php  } ?>/> 加盟订单总额(完成的订单)
                        </label>
		    <label class="radio radio-inline" style="width:240px">
                              <input type="radio" name="setdata[leveltype]" value="1" <?php  if($set['leveltype']==1) { ?>checked<?php  } ?>/> 一级加盟订单金额(完成的订单)
                        </label>		<br/>
						
					
		   <label class="radio radio-inline" style="width:240px">
                              <input type="radio" name="setdata[leveltype]" value="2" <?php  if($set['leveltype']==2) { ?>checked<?php  } ?>/> 加盟订单总数(完成的订单)
                        </label>
						   <label class="radio radio-inline" style="width:240px">
                              <input type="radio" name="setdata[leveltype]" value="3" <?php  if($set['leveltype']==3) { ?>checked<?php  } ?>/> 一级加盟订单总数(完成的订单)
                        </label>
				<br /><br />	
		   <label class="radio radio-inline" style="width:240px">
...
<br/>				
		 ...
		 <br />
	              <label class="radio radio-inline" style="width:240px">
                              <input type="radio" name="setdata[leveltype]" value="6" <?php  if($set['leveltype']==6) { ?>checked<?php  } ?>/> 下线总人数（加盟商+非加盟商）
                        </label>		
		   <label class="radio radio-inline" style="width:240px">
                              <input type="radio" name="setdata[leveltype]" value="7" <?php  if($set['leveltype']==7) { ?>checked<?php  } ?>/> 一级下线人数（加盟商+非加盟商）
                        </label> 
					<br />	
		   <label class="radio radio-inline" style="width:240px">
                              <input type="radio" name="setdata[leveltype]" value="8" <?php  if($set['leveltype']==8) { ?>checked<?php  } ?>/> 下级加盟商总人数
                        </label>		
		   <label class="radio radio-inline" style="width:240px">
                              <input type="radio" name="setdata[leveltype]" value="9" <?php  if($set['leveltype']==9) { ?>checked<?php  } ?>/> 一级加盟商人数
                        </label>
				<br /><br />
				 <label class="radio radio-inline" style="width:240px">
                              <input type="radio" name="setdata[leveltype]" value="10" <?php  if($set['leveltype']==10) { ?>checked<?php  } ?>/> 已提现佣金总金额
                        </label>	
                        <span class="help-block">默认为加盟订单总金额</span>
        ...
        <div class="col-sm-9 col-xs-12">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9 col-xs-12">
                    <?php  echo tpl_form_field_image('setdata[regbg]',$set['regbg'],'../addons/sea/plugin/commission/template/mobile/default/static/images/bg.png')?>
                </div>
            </div>
			<div class="form-group">
                <label class="col-xs-12 col-sm-3 col-md-2 control-label">统一店招图片</label>
                <div class="col-sm-9 col-xs-12">
                    <?php  echo tpl_form_field_image('setdata[dzbg]',$set['dzbg'],'../addons/sea/plugin/commission/template/mobile/default/static/images/bg.png')?>
                </div>
            </div>
        ...
        <div class='panel-body'>
             <div class="form-group">
                ...
                <div class="col-sm-9 col-xs-12">
                      <div class="input-group">
                        ...
                        <input type="text" name="setdata[buttontext]" class="form-control" value="<?php echo empty($set['buttontext'])?'我要加盟':$set['buttontext']?>"  />
                        <span class="input-group-addon">商品详情页面“我要加盟”按钮文字,建议使用4个汉字</span>
                    </div>
                </div>
                </div>
              <div class="form-group">
                    ...
                    <div class="col-sm-9 col-xs-12">
                          <div class="input-group">
                            <div class="input-group-addon">加盟商名称</div>
                            <input type="text" name="texts[agent]" class="form-control" value="<?php echo empty($set['texts']['agent'])?'加盟商':$set['texts']['agent']?>"  />
                        </div>
                    </div>
              </div>
             <div class="form-group">
            ...
            <div class="form-group">
                    ...
                    <div class="col-sm-9 col-xs-12">
                          <div class="input-group">
                            <div class="input-group-addon">加盟中心</div>
              ...
              <div class="form-group">
                    ...
                    <div class="col-sm-9 col-xs-12">
                          <div class="input-group">
                            <div class="input-group-addon">成为加盟商</div>
                            <input type="text" name="texts[become]" class="form-control" value="<?php echo empty($set['texts']['become'])?'成为加盟商':$set['texts']['become']?>"  />
                        </div>
                    </div>
              </div>
             <div class="form-group">
              ...
              <div class="form-group">
                    ...
                    <div class="col-sm-9 col-xs-12">
                          <div class="input-group">
                            <div class="input-group-addon">加盟佣金</div>
                            <input type="text" name="texts[commission1]" class="form-control" value="<?php echo empty($set['texts']['commission1'])?'加盟佣金':$set['texts']['commission1']?>"  />
                        </div>
                    </div>
              </div>
             <div class="form-group">
			...
			<div class="form-group">
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                    ...
                    <div class="col-sm-9 col-xs-12">
                          <div class="input-group">
                            <div class="input-group-addon">加盟订单</div>
...
<!-- Author:Y.yang Date:2016-04-08 Content:购买指定商品成为加盟商，（选择商品的输入框和JS） -->
    ...
    function formcheck(){
        ...
        if( become_child=='1'  || become_child=='2' ){
            if( $(":radio[name='setdata[become]']:checked").val() =='0'){
              alert('成为下线条件选择了首次下单/首次付款，成为加盟商条件不能选择无条件!')   ;
              return false;
            }
        }
        return true;
