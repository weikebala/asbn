        ...
        <div class="modal-content">
            ...
            <div class="modal-body" >
                <ul class="nav nav-tabs">
                    ...
                    <?php  if(p('article')) { ?><li id="fe-tab-link-nav-6"><a href="javascript:switchtab('fe-tab-link',6);">文章营销页面</a></li><?php  } ?>
		<?php  if(p('coupon')) { ?><li id="fe-tab-link-nav-7"><a href="javascript:switchtab('fe-tab-link',7);">超级券页面</a></li><?php  } ?>
                </ul>
                <div>
