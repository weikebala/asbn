...
<div class="main">
    <form id="dataform" action="" method="post" class="form-horizontal form">
	    ...
	    <div class="form-group">
                    <label class="col-xs-12 col-sm-3 col-md-2 control-label">   <label>
				 <input type='checkbox'  class="checkline-all" value="commission" /> 海软加盟
			    </label>	</label>
                    <div class="col-sm-9">
			    <label class="checkbox-inline">
				 <input type='checkbox' value="agent" name="commission[]" /> 加盟商资格(清除所有会员的加盟商资格)
			    </label>	
			    <label class="checkbox-inline">
				 <input type='checkbox' value="relation" name="commission[]" /> 上下级关系(清除所有会员的上下级)
			    </label>	
			    <label class="checkbox-inline">
				 <input type='checkbox' value="agentlevel" name="commission[]" /> 加盟商等级(清除所有会员的加盟商等级)
			    </label>	
			    <label class="checkbox-inline">
				 <input type='checkbox' value="level" name="commission[]" /> 加盟商等级
			    </label>	
			     <label class="checkbox-inline">
