...
<script language='javascript' src="../addons/sea/plugin/poster/static/js/designer.js"></script>
<script language='javascript' src="../addons/sea/plugin/poster/static/js/jquery.contextMenu.js"></script>
<link href="../addons/sea/plugin/poster/static/js/jquery.contextMenu.css" rel="stylesheet">
<style type='text/css'>
    #poster {
                                    ...
                                    <td style='width:320px;padding:10px;' valign='top'>
                                        <div id='poster'>
                                          ...
                                          <div class="drag" type="<?php  echo $d['type'];?>" index="<?php  echo $key+1?>" style="zindex:<?php  echo $key+1?>;left:<?php  echo $d['left'];?>;top:<?php  echo $d['top'];?>;
                                               ...
                                               > 
                                               <?php  if($d['type']=='qr') { ?>
                                                 <img src="../addons/sea/plugin/poster/static/images/qr.jpg" />
                                               <?php  } else if($d['type']=='head') { ?>
                                                  <img src="../addons/sea/plugin/poster/static/images/head.jpg" />
                                                <?php  } else if($d['type']=='img' || $d['type']=='thumb') { ?>
                                                  <img src="<?php echo empty($d['src'])?'../addons/sea/plugin/poster/static/images/img.jpg':tomedia($d['src'])?>" />
    ...
    $(function(){
        ...
        $('.btn-com').click(function(){
           ...
           clearTimers();
            ...
            var img = "";
            if(type=='qr'){
                img = '<img src="../addons/sea/plugin/poster/static/images/qr.jpg" />';
            }
            else if(type=='head'){
                img = '<img src="../addons/sea/plugin/poster/static/images/head.jpg" />';
            }else  if(type=='img' || type=='thumb'){
                img = '<img src="../addons/sea/plugin/poster/static/images/img.jpg" />';
            } 
