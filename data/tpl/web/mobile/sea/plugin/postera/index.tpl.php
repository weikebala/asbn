...
<script language='javascript' src="../addons/sea/plugin/postera/static/js/designer.js"></script>
<script language='javascript' src="../addons/sea/plugin/postera/static/js/jquery.contextMenu.js"></script>
<link href="../addons/sea/plugin/postera/static/js/jquery.contextMenu.css" rel="stylesheet">
<style type='text/css'>
    #postera {
                                    ...
                                    <td style='width:320px;padding:10px;' valign='top'>
                                        <div id='postera'>
                                          ...
                                          <div class="drag" type="<?php  echo $d['type'];?>" index="<?php  echo $key+1?>" style="zindex:<?php  echo $key+1?>;left:<?php  echo $d['left'];?>;top:<?php  echo $d['top'];?>;
                                               ...
                                               > 
                                               <?php  if($d['type']=='qr') { ?>
                                                 <img src="../addons/sea/plugin/postera/static/images/qr.jpg" />
                                               <?php  } else if($d['type']=='head') { ?>
                                                  <img src="../addons/sea/plugin/postera/static/images/head.jpg" />
                                                <?php  } else if($d['type']=='img' || $d['type']=='thumb') { ?>
                                                  <img src="<?php echo empty($d['src'])?'../addons/sea/plugin/postera/static/images/img.jpg':tomedia($d['src'])?>" />
               ...
               生成设置
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9 col-xs-12">
                        ...
                        <span class='help-block'>是否允许非加盟商生成自己的海报</span>
                      <?php  } else { ?>
                      <div class='form-control-static'><?php  if($item['isopen']==1) { ?>所有人<?php  } else { ?>加盟商<?php  } ?></div>
                      <?php  } ?>
                    </div> 
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9 col-xs-12">
                        ...
                        <input type="text" name="opentext" class="form-control" value="<?php  echo $item['opentext'];?>" />
                         <span class='help-block'>例如：您还不是我们加盟商，去努力成为加盟商，拥有你的专属海报吧!</span>
                             <?php  } else { ?>
                            <div class='form-control-static'><?php  if(empty($item['opentext'])) { ?>您还不是我们加盟商，去努力成为加盟商，拥有你的专属海报吧!<?php  } else { ?><?php  echo $item['opentext'];?><?php  } ?></div>
                        <?php  } ?>
                    </div>
                </div>
                <div class="form-group">
       ...
       <div class="panel-heading">
           ...
           <div class='panel-body'>
            ...
            <div class='panel-body'>
                 <div class="form-group">
                    ...
                    <div class="col-sm-9 col-xs-12">
                       <?php if( ce('postera' ,$item) ) { ?>
                        ...
                        <span class='help-block'>扫码关注直接成为推荐人的下线，不受加盟【基础设置】的成为下线条件控制</span>
                      <?php  } else { ?>
              ...
              <div class="form-group">
                    <label class="col-xs-12 col-sm-3 col-md-2 control-label">扫码关注成为加盟商</label>
                    <div class="col-sm-9 col-xs-12">
                          <?php if( ce('postera' ,$item) ) { ?>
                        <label class="radio-inline">
                        ...
                        <span class='help-block'>扫码关注直接成为推荐人的下线并成为加盟商，不受加盟【基础设置】的成为加盟商下线条件控制（仅是否直接审核通过由基础设置控制）</span>
                       <?php  } else { ?>
    ...
    $(function(){
        ...
        $('.btn-com').click(function(){
           ...
           clearTimers();
            ...
            var img = "";
            if(type=='qr'){
                img = '<img src="../addons/sea/plugin/postera/static/images/qr.jpg" />';
            }
            else if(type=='head'){
                img = '<img src="../addons/sea/plugin/postera/static/images/head.jpg" />';
            }else  if(type=='img' || type=='thumb'){
                img = '<img src="../addons/sea/plugin/postera/static/images/img.jpg" />';
            } 
