<?php defined('IN_IA') or exit('Access Denied');?> <div class="form-group">
    ...
    <div class="col-sm-9 col-xs-12 chks">
           <?php if( ce('creditcreditshop.goods' ,$item) ) { ?>
...
<div class="form-group">
    <label class="col-xs-12 col-sm-3 col-md-2 control-label">会员等级参与权限</label>
    <div class="col-sm-9 col-xs-12 chks" >
              <?php if( ce('creditcreditshop.goods' ,$item) ) { ?>
...
<div class="form-group">
    <label class="col-xs-12 col-sm-3 col-md-2 control-label">会员组参与权限</label>
    <div class="col-sm-9 col-xs-12 chks" >
            <?php if( ce('creditcreditshop.goods' ,$item) ) { ?>
                <label class="checkbox-inline">
