...
<div class="form-group">
    ...
    <div class="col-sm-6 col-xs-6">
        ...
        <label class="radio-inline"><input type="radio" name="isverify" value="0" <?php  if(empty($item['isverify'])) { ?>checked="true"<?php  } ?>  /> 需要快递</label>
        <label class="radio-inline"><input type="radio" name="isverify" value="1" <?php  if($item['isverify'] == 1) { ?>checked="true"<?php  } ?>   /> 线下兑换</label>
...
<div class="form-group">
    <label class="col-xs-12 col-sm-3 col-md-2 control-label">线下兑换门店选择</label>
    <div class="col-sm-9 col-xs-12 chks">
       <?php if( ce('creditshop.goods' ,$item) ) { ?>
        <div class='input-group'>
            <input type="text" name="store" maxlength="30" class="form-control" readonly />
