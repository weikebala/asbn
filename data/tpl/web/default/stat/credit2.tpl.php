...
<ul class="nav nav-tabs">
	<li <?php  if($do == 'index') { ?>class="active"<?php  } ?>><a href="<?php  echo url('stat/credit2')?>">余额日志</a></li>
	<li <?php  if($do == 'chart') { ?>class="active"<?php  } ?>><a href="<?php  echo url('stat/credit2/chart')?>">余额统计</a></li>
</ul>
<?php  if($do == 'chart') { ?>
	...
	<div class="panel-body" id="scroll">
		<div class="pull-left">
			<form action="" id="form1">
				...
				<input name="a" value="credit2" type="hidden" />
...
<div class="panel panel-info">
	...
	<div class="panel-body">
		<form action="./index.php" method="get" class="form-horizontal" role="form">
			...
			<input type="hidden" name="a" value="credit2">
