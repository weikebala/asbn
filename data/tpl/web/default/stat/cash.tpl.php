...
<ul class="nav nav-tabs">
	<li <?php  if($do == 'index') { ?>class="active"<?php  } ?>><a href="<?php  echo url('stat/cash')?>">消费日志</a></li>
	<li <?php  if($do == 'chart') { ?>class="active"<?php  } ?>><a href="<?php  echo url('stat/cash/chart')?>">消费统计</a></li>
</ul>
<?php  if($do == 'chart') { ?>
