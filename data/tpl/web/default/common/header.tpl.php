	...
	<div class="navbar navbar-inverse navbar-static-top" role="navigation" style="position:static;">
		<div class="container-fluid">
			<ul class="nav navbar-nav">
				<li><a href="./?refresh"><i class="fa fa-reply-all"></i>返回</a></li>
				 <li><a href="<?php  echo url('site&a=entry&p=goods&do=shop&m=sea');?>"><i class='fa fa-shopping-cart'></i>商品</a></li>
				  <li><a href="<?php  echo url('site&a=entry&op=display&do=order&m=sea');?>"><i class='fa fa-file-text-o'></i> 订单</a></li>
				   <li><a href="<?php  echo url('site&a=entry&p=log&type=0&do=finance&m=sea');?>"><i class='fa fa-money'></i>财务</a></li>
				    <li><a href="<?php  echo url('site&a=entry&p=sale&do=statistics&m=sea');?>"><i class='fa fa-bar-chart-o '></i>统计</a></li>	
                    <li><a href="<?php  echo url('site&a=entry&p=list&do=member&m=sea');?>"><i class='fa fa-user'></i>会员</a></li>							
				<li><a href="<?php  echo url('home&a=welcome&do=ext&m=sea');?>"><i class='fa fa-sitemap fa-fw'></i>入口</a></li>
                <li><a href="<?php  echo url('site&a=entry&p=fans&do=leaderboard&m=sea');?>"><i class='fa fa-cubes'></i>榜单</a></li>
				<li><a href="<?php  echo url('site&a=entry&op=list&do=plugins&m=sea');?>"><i class='fa fa-cubes'></i>插件</a></li>
				<li><a href="<?php  echo url('site&a=entry&op=shop&do=sysset&m=sea');?>"><i class="fa fa-cog"></i>设置</a></li>
				<li ><a href="<?php  echo url('home/welcome/platform');?>"><i class="fa fa-weixin fa-fw"></i>微信</a></li>
				<li><a href="<?php  echo url('home/welcome/mc');?>"><i class="fa fa-gift"></i>粉丝</a></li>
				<li><a href="<?php  echo url('home/welcome/ext');?>"><i class="fa fa-cubes"></i>其他</a></li>
			</ul>
		...
		<div class="navbar navbar-inverse navbar-static-top" role="navigation" style="position:static;">
			<div class="container-fluid">
				<ul class="nav navbar-nav">
					...
					<?php  if(IMS_FAMILY != 'x') { ?>
						<li><a href="http://bbs.iseasoft.cn"><i class="fa fa-comment"></i>海软论坛</a></li>
						<li><a href="http://wpa.b.qq.com/cgi/wpa.php?ln=1&key=XzgwMDA4MzA3NV8yMTc1MThfODAwMDgzMDc1XzJf"><i class="fa fa-suitcase"></i>联系客服</a></li>
					<?php  } ?>
				</ul>
				<ul class="nav navbar-nav navbar-right">
