...
<title><?php  echo $this->set['texts']['order_area']?></title>
<style type="text/css">
...
<div class="order_top">
    <div class="title" onclick='history.back()'><i class='fa fa-chevron-left'></i> <?php  echo $this->set['texts']['order_area']?>(<?php  echo $ordercount;?>)</div>
...
function bindScroller(){
        ...
        $(window).scroll(function () {
            ...
            if ($(document).height() <= totalheight) {
                ...
                if (stop == true) {
                    ...
                    page++; 
                    core.pjson('bonus/order_area', {status:current_status,page: page}, function (morejson) {
                        stop = true;
        ...
        function getOrder(status) {
            ...
            core.pjson('bonus/order_area', {status:status, page: page}, function (json) {
