...
<script type="text/javascript">
    ...
    require(['tpl', 'core'], function(tpl, core) {
        ...
        core.pjson('verify/detail',{id:'<?php  echo $_GPC['id'];?>'},function(json){
              
                 if(json.status==0){
                     core.message(json.result,"" ,'error');
                     return;
                 }
                 ...
                 $(".order_complete").click(function(){
                      ...
                      core.tip.confirm('确认已使用?',function(){
                      
                         core.pjson('verify/complete',{id:'<?php  echo $_GPC['id'];?>'},function(json){
                                 if(json.status==1){
                                    core.message('操作成功, 请返回微信, 无需其他操作!',"" ,'success',"WeixinJSBridge.call('closeWindow');");
                                    return;
                                 }
                                 core.message(json.result,'','error',"WeixinJSBridge.call('closeWindow');");
                             },true,true);
                       });
                 });
