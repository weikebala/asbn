...
.foot-nav{ position: fixed;bottom: 53px;height:46px;background: <?php  if($color['color']) { ?><?php  echo $color['color'];?><?php  } else { ?>rgba(255,0,0,0.6)<?php  } ?>;color: #fff;width: 100%;z-index: 99;}
