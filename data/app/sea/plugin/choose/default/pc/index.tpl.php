...
<title></title>
<link rel="stylesheet" type="text/css" href="../addons/sea/plugin/choose/template/mobile/default/static/css/dish/wei_dialog.css" media="all" />
<link rel="stylesheet" type="text/css" href="../addons/sea/plugin/choose/template/mobile/default/static/css/dish/wei_canyin.css" media="all" />
<link rel="stylesheet" type="text/css" href="../addons/sea/plugin/choose/template/mobile/default/static/css/dish/home.css" media="all">
<script type="text/javascript" src="../addons/sea/plugin/choose/template/mobile/default/static/js/dish/jquery-1.8.3.min.js"></script>
<script type="text/javascript" src="../addons/sea/plugin/choose/template/mobile/default/static/js/dish/wei_webapp_v2_common.js"></script>
<style type="text/css">
  .num{width: 30px;
...
float: left;
height: 20px;}
.subtract,.add{border-radius: 100px;
border: 1px <?php  if($color['color']) { ?><?php  echo $color['color'];?><?php  } else { ?>rgba(255,0,0,0.6)<?php  } ?> solid;
width: 20px;
height: 20px;
display: inline-block;
color: <?php  if($color['color']) { ?><?php  echo $color['color'];?><?php  } else { ?>rgba(255,0,0,0.6)<?php  } ?>;
text-align: center;
line-height: 20px;
float: left;
}
...
text-align: center;
display: block;
background: <?php  if($color['color']) { ?><?php  echo $color['color'];?><?php  } else { ?>rgba(255,0,0,0.6)<?php  } ?>;
border-radius: 50px;
width: 20px;
height: 20px;
line-height: 20px;font-weight: bold;}
#page_allMenu nav dl dd.active {
  color: #fff;
  background-color:<?php  if($color['color']) { ?><?php  echo $color['color'];?><?php  } else { ?>rgba(255,0,0,0.6)<?php  } ?>; 
}

#page_allMenu section article dl dd em.eys{ color: #A8A8A8 !important;font-size: 12px;font-weight: normal;padding-top: 10px}
#page_allMenu section article dl dd em{ color: <?php  if($color['color']) { ?><?php  echo $color['color'];?><?php  } else { ?>rgba(255,0,0,0.6)<?php  } ?>;font-weight: bold;font-size: 14px}
...
<div class="center">
    <div class="notice">
    <!-- <img src="../addons/sea/template/mobile/default/static/css/dish/img/notice.png" class="not-pos"> -->
      <div><marquee scrollamount="1" scrolldelay="0" direction="left"></marquee></div>
    <!-- <a href="javascript:;" class="close-pos"><img src="../addons/sea/template/mobile/default/static/css/dish/img/close.png" class="close-pos"> --></a>
    </div>
    <nav id="navBar" >
...
.foot-nav{ position: fixed;bottom: 53px;height:46px;background: <?php  if($color['color']) { ?><?php  echo $color['color'];?><?php  } else { ?>rgba(255,0,0,0.6)<?php  } ?>;color: #fff;width: 720px;z-index: 99;}
...
.foot-nav a{float: right;height: 30px;background: #fff;line-height: 30px;color: <?php  if($color['color']) { ?><?php  echo $color['color'];?><?php  } else { ?>rgba(255,0,0,0.6)<?php  } ?>;text-align: center;padding: 0 14px;margin:9px;border-radius: 18px}
</style>
<div class="foot-nav" id="total">
  <span>0</span>
  <p>总价：￥0.00</p>
  <a href="<?php  echo $this->createMobileUrl('shop/cart')?>">选好了</a>
</div>
...
<script language='javascript'>
    ...
    var recommand = [];
    var pcate = 'rec';
    var pageid = "<?php  echo $_GPC['pageid'];?>";
    require(['tpl', 'core'], function (tpl, core) {
     ...
     /*function bindChildEvents(){
        ...
        function setCategory(){
            ...
            core.pjson('choose/list_goods',{pcate:pcate,pageid:pageid,op:'moren'}, function (json) {
                            result = json.result;
                            ...
                            if (store.length) {                                                             
                                for (var i = 0; i < store.length ;i++ ) {
                                    ...
                                    h +=  '</dd><dd><em class="eys">已售'+store[i].sales+store[i].unit+'</em></dd><dd><em>'+store[i].marketprice+'元<i>/'+store[i].unit+'</i></em>';

                                    h +=  '<div style="float:right;width:auto"><a href="javascript:;" style="display:none;" class="subtract" data-id="'+store[i].id+'" >-</a><input type="text" style="display:none;" class="num" value="0"> <a href="javascript:;" class="add" data-id="'+store[i].id+'">+</a></div></dd></dl>';
                                };
        ...
        function getTotalPrice(){
            require(['core'],function(core){
                core.json('shop/cart',{op:'display'},function(ret){
                     $('#total').find("span").html(ret.result.total);
                     $('#total').find("p").html('总价：￥' + ret.result.totalprice);
                        /*if(ret.status==1){ 
                            core.tip.show(ret.result.message);                            var cartdiv = $('.cart'); 
                            if( cartdiv.find('b').length<=0){                                                                                                 cartdiv.append('<b>'+ ret.result.cartcount +"</b>");
                            } else {
        ...
        core.pjson('choose/list_category',{op:'category',level:3,pageid:pageid}, function (json) {
                 result = json.result;
                ...
                $('body').on('click','.add',function(){
                    ...
                    require(['core'],function(core){
                        ...
                        core.json('shop/cart',{op:'add', id:id,total:num},function(ret){
