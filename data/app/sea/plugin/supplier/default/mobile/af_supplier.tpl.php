...
<script id="member_info" type="text/html">
    ...
    <div class="info_main">
        <div class="line"><div class="title">用户名</div><div class='info'><div class='inner'><input type="text" id='username' placeholder="请输入用户名"  value="" /></div></div></div>
        <div class="line"><div class="title">密码</div><div class='info'><div class='inner'><input type="text" id='password' placeholder="请输入密码"  value="" /></div></div></div>
