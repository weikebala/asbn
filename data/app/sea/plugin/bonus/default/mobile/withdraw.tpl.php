...
.gold_top .num a {height:40px; width:auto; background:url(../addons/sea/plugin/commission/template/mobile/default/static/images/gold_ico1.png) right 16px no-repeat; float:right; padding-right:26px; line-height:50px; color:#fff; font-size:16px;}
