...
.gold_top .num a { width:auto; /*height:40px;background:url(../addons/sea/plugin/commission/template/mobile/default/static/images/gold_ico1.png) right 16px no-repeat;padding-right:26px;line-height:50px;  */padding: 30px 10px 0 10px;
...
<script id='tpl_main' type='text/html'>
    ...
    <div class="gold_num" style="border:0px;height:90px">
        ...
        <div class="nav" ><div class="title">已申请<?php  echo $this->set['texts']['commission']?></div><div class="num"><%member.commission_apply%></div><div class='tip'><?php  echo $this->set['texts']['commission_apply']?></div></div>
        <div class="nav navbor"><div class="title"><?php  echo $this->set['texts']['commission_check']?></div><div class="num"><%member.commission_check%></div><div class='tip'>审核通过的<?php  echo $this->set['texts']['commission']?></div></div>
