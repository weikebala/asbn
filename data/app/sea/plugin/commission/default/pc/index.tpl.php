...
.top-fx .top_1 .ico {height:40px; width:30px; background:url(../addons/sea/plugin/commission/template/mobile/default/static/images/gold_ico2.png) 0px 10px no-repeat; margin-bottom:74px; float:right;}
...
.topbonus .top_1 .ico {height:40px; width:30px; background:url(../addons/sea/plugin/commission/template/mobile/default/static/images/gold_ico2.png) 0px 10px no-repeat; margin-bottom:74px; float:right;}
        ...
        <div class="topbar">
            ...
            <div class="user_info">
                ...
                <div class="user-dj">
                    ...
                    <%/if%>]<%if set.levelurl!=''%><i class='fa fa-question-circle' ></i><%/if%>
                </div>
        ...
        <div class="top-fx">
            <div class="top_2">
                ...
                <div class="pr-jine">
                    ...
                    <a <%if commission_ok<=0 || commission_ok< set.withdraw || commission_ok< set.consume_withdraw %>href="javascript:;"<%else%>href="<?php  echo $this->createPluginMobileUrl('commission/apply')?>"<%/if%> id='withdraw' ><span <%if commission_ok<=0 || commission_ok< set.withdraw%>class='disabled'<%/if%> ><?php  echo $this->set['texts']['withdraw']?></span></a>
                </div>
            </div>
            <div class="top_1">
                <div class="text">
