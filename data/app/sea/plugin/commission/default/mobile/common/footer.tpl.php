...
<footer id="footer-nav">
                <ul class="menu-list">
                    <li <?php  if($footer_current=='first') { ?>class='active'<?php  } ?>><a href="<?php  echo $this->createMobileUrl('shop')?>"><i class="fa fa-home"></i><span>小店</span></a></li>
                    <li <?php  if($footer_current=='second') { ?>class='active'<?php  } ?>><a href="/app/index.php?i=2&c=entry&p=designer&pageid=27&m=sea&do=plugin"><i class="fa fa fa-list"></i><span>品牌馆</span></a></li>
                    <li <?php  if($footer_current=='commission') { ?>class='active'<?php  } ?>><a href="<?php  echo $this->createPluginMobileUrl('commission')?>"><i class="fa fa-sitemap"></i><span>加盟中心</span></a></li>
