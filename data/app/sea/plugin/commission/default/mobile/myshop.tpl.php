...
<title>爱尚彼岸<?php  echo $shop['name'];?></title>
<style type="text/css">
...
<div class="top">
   <div class="bgimg">
        <img src="<%<%if shop.img%><%shop.img%><%else%>../addons/sea/template/mobile/default/static/images/bg.jpg<%/if%>">
        <div class="shopimg"><img src="<%shop.logo%>"></div>
        <div class="shopname">爱尚彼岸<%shop.name%></div>
