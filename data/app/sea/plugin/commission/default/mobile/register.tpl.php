...
<!--<div class="input"><input type="text" id='mobile' placeholder="请填写手机号码方便联系"  value="<?php  echo $member['mobile'];?>"/></div>-->
	...
	<div class="input"><input type="text" id='sfz' placeholder="请填写身份证"  value="<?php  echo $member['sfz'];?>"/></div>
	<div class="input"><input type="text" id='alipayuser' placeholder="请填写支付宝"  value="<?php  echo $member['alipayuser'];?>"/></div>
    ...
    require(['tpl', 'core'], function(tpl, core) {
        ...
        core.pjson('commission/register',{mid:"<?php  echo $mid;?>"},function(json){
           ...
           $('#submit').click(function(){
			   ...
			   if($('#sfz').isEmpty()){
                   core.tip.show('请填写身份证号!');
                   return;
               }
			  /* if($('#alipayuser').isEmpty()){
                   core.tip.show('请填写支付宝账号!');
                   return;
               }*/
               /*if(!$('#mobile').isMobile()){
