...
<link href="../addons/sea/plugin/creditshop/template/pc/default/images/css.css" rel="stylesheet" type="text/css"/>
<title>积分商城</title>
...
.jf-tit{color: #333;padding-bottom: 20px;height: 47px;background: #fff;line-height: 47px;padding: 0 10px}
.jf-tit h2 {font-weight: 700;float: left;font-size: 16px;color: #333;font-family: "微软雅黑";line-height: 47px}
.jf-tit span{    padding-left: 10px;color: #999;font-size: 12px}
.jf-tit span a{    padding:0 4px;color: #e02f2f}
.jf-tit .tx-list{ background: #f5fbef;color: #323333;border: 1px solid #bfd6af;font-size: 12px;padding: 4px}
...
<script id='tpl_main'  type='text/html'>
    ...
    <div class="jf-tit">
        <h2>我的积分</h2>
        <span>可用积分<a href="<?php  echo $this->createPluginMobileUrl('creditshop/creditlog')?>"><%credit%></a>分</span>
        <a class="tx-list" href="<?php  echo $this->createPluginMobileUrl('creditshop/log')?>"> 兑换记录</a>
    </div>
    <%if tops.length>0%>
    <div class="top01">
       <div class="left">
        ...
        <div class="right">
             ...
             <a href="<?php  echo $this->createPluginMobileUrl('creditshop/detail')?>&id=<%tops[1].id%>">
                        <div class="good">
                           <div style="height:99px; float:left; margin-right:-109px; width:100%;">
                               <div class="info">
    ...
    <div class="index_title"><span>推荐专区</span></div>
        <div class="list">
    ...
    <%if vips.length>0%>
    <div class="index_title"><span>特权专区</span></div>
        <div class="list">
           <%each vips as value%>
           <a href="<?php  echo $this->createPluginMobileUrl('creditshop/detail')?>&id=<%value.id%>">
                <div class="good">
    ...
    <%if times.length>0%>
    <div class="index_title"><span>限时活动</span></div>
        <div class="list">
           <%each times as value%>
           <a href="<?php  echo $this->createPluginMobileUrl('creditshop/detail')?>&id=<%value.id%>">
                <div class="good">
    ...
    <%if reccategory.length>0%>
        <%each reccategory as rc%>
                ...
                <div class="index_title"><span><%rc.name%></span></div>
                    <div class="list">
