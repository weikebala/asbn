...
<title>优惠券领取中心</title>
<link rel="stylesheet" type="text/css" href="../addons/sea/plugin/coupon/template/mobile/default/images/style.css">
<style type="text/css">
  ...
  .banner .main_image li a{display:block;width:100%;} 
    ...
    div.flicking_con a{position:relative; width:10px;height:9px;background:url('../addons/sea/template/mobile/default/static/images/dot.png') 0 0 no-repeat;display:inline-block;text-indent:-15165px; text-indent:-1000px}
...
<div class="coupon_item" onclick="location.href = '<?php  echo $this->createPluginMobileUrl('coupon/detail')?>&id=<%coupon.id%>'">
          <%if coupon.past%><div class="coupon_past"><img src="../addons/sea/plugin/coupon/template/mobile/default/images/past.png"></div><%/if%>
