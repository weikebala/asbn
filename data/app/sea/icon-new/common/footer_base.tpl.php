...
$('#shsh').click(function(){
    var data_type = $('#show').attr('data-type');
    //alert(1);
    if(data_type == 1)
    {
        $('#show').show();
        $('#show').attr('data-type','2');
...
<?php  if(!$uploadappnoshow) { ?>
<?php (!empty($this) && $this instanceof WeModuleSite) ? (include $this->template('common/uploadapp', TEMPLATE_INCLUDEPATH)) : (include template('common/uploadapp', TEMPLATE_INCLUDEPATH));?>
<?php  } ?>
</body>
</html>
