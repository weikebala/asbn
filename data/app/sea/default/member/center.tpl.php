...
<div class="cart">
    ...
    <%/if%> 
     ...
     <%if shopset.yj%>
       <a href="<?php  echo $this->createPluginMobileUrl('commission/yongjin')?>"><div class="list1" ><i class="fa fa-gift"></i>佣金排行榜<i class="fa fa-angle-right" style="color:#999; font-size:26px; float:right; line-height:44px;"></i></div></a>
    <%/if%>

    <%if shopset.ye%>
       <a href="<?php  echo $this->createMobileUrl('member/yephb')?>"><div class="list1" style="margin:0px; border-bottom:0px;"><i class="fa fa-thumbs-o-up" style="color:#cc6;"></i>消费排行榜<i class="fa fa-angle-right" style="color:#999; font-size:26px; float:right; line-height:44px;"></i></div></a>
    <%/if%>

    <%if shopset.jf%>
       <a href="<?php  echo $this->createMobileUrl('member/phb')?>"><div class="list1" ><i class="fa fa-gift"></i>积分排行榜<i class="fa fa-angle-right" style="color:#999; font-size:26px; float:right; line-height:44px;"></i></div></a>
    <%/if%>
