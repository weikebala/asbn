...
<link rel="stylesheet" type="text/css" href="../addons/sea/template/pc/default/static/css/footer.css">
<div class="cover-page-foot fl wfs">
    <p class="subnav">
        ...
        <?php  } else { ?>
            ...
            <?php  } ?>
            <a target="_blank" href="<?php  echo $this->createMobileUrl('member/info')?>">会员中心</a>
        <?php  } ?>
    </p>
