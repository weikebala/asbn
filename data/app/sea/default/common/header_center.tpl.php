...
<head>
    ...
    <link rel="stylesheet" href="../addons/sea/template/pc/default/static/css/bootstrap.min.css">
    <link rel="stylesheet" href="../addons/sea/template/pc/default/static/css/member-center.css">
    <link rel="stylesheet" type="text/css" href="../addons/sea/template/pc/default/static/css/style.css">
    </head>
    <body>
...
<div class="head fl wfs">
    <div class="wrapper">
        <a class="logo" href="<?php  echo $this->createMobileUrl('shop/index')?>">
            ...
            <?php  } else { ?>
                <img src="../addons/sea/template/pc/default/static/images/logo.png" title="" alt="我是默认logo">
            <?php  } ?>
        </a>
        <div class="nav">
